...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGOctaneProcessingOrderedState_h
#define IGOctaneProcessingOrderedState_h
@import Foundation;
...
@interface IGOctaneProcessingOrderedState : NSObject<NSObject>
...
#endif /* IGOctaneProcessingOrderedState_h */
