...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGStoryRollCallPostCaptureFooterView_h
#define IGStoryRollCallPostCaptureFooterView_h
@import Foundation;
...
@interface IGStoryRollCallPostCaptureFooterView : UIView<IGStoryPreviewFooterViewType> {
  /* instance variables */
...
#endif /* IGStoryRollCallPostCaptureFooterView_h */
