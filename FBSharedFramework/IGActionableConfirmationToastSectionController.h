...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGActionableConfirmationToastSectionController_h
#define IGActionableConfirmationToastSectionController_h
@import Foundation;
...
@interface IGActionableConfirmationToastSectionController : IGListGenericSectionController<NSObject> {
  /* instance variables */
  NSObject<IGActionableConfirmationToastSectionControllerDualButtonDelegate> *_dualButtonDelegate;
}

@property (weak, nonatomic) NSObject<IGActionableConfirmationToastSectionControllerDelegate> *delegate;
...
#endif /* IGActionableConfirmationToastSectionController_h */
