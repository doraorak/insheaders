...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGReactionStickerView_h
#define IGReactionStickerView_h
@import Foundation;
...
@interface IGReactionStickerView : UIView<IGStickerViewType, IGEditableStickerViewType, IGConstrainedZPositionStickerViewType> {
  /* instance variables */
...
@property (nonatomic) BOOL viewerHasReacted;
...
/* instance methods */
- (id)initWithShouldAddShadow:(BOOL)shadow;
- (void)layoutSubviews;
- (id)stickerView;
