...
//    - LC_SOURCE_VERSION: 
//
#ifndef FXSaveRequest_h
#define FXSaveRequest_h
@import Foundation;
...
@interface FXSaveRequest : NSObject<FXRequestDebuggable, FXRequestProtocol>

@property (copy, nonatomic) id /* block */ itemBuilder;
...
/* instance methods */
- (id)initWithQuery:(id)query itemBuilder:(id /* block */)builder;
- (id)initWithQuery:(id)query itemBuilder:(id /* block */)builder logLocation:(id)location;
@end

#endif /* FXSaveRequest_h */
