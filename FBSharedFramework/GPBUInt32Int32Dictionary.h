...
//    - LC_SOURCE_VERSION: 
//
#ifndef GPBUInt32Int32Dictionary_h
#define GPBUInt32Int32Dictionary_h
@import Foundation;
...
/* instance methods */
- (id)init;
- (id)initWithInt32s:(const int *)int32s forKeys:(const unsigned int *)keys count:(unsigned long long)count;
...
#endif /* GPBUInt32Int32Dictionary_h */
