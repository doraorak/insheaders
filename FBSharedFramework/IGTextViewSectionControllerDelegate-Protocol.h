...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGTextViewSectionControllerDelegate_Protocol_h
#define IGTextViewSectionControllerDelegate_Protocol_h
@import Foundation;
...
#endif /* IGTextViewSectionControllerDelegate_Protocol_h */
