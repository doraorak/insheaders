...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGDirectThreadActionLog_h
#define IGDirectThreadActionLog_h
@import Foundation;
...
@interface IGDirectThreadActionLog : NSObject<IGDirectUIMessageProviding> {
  /* instance variables */
  BOOL _hidden;
  NSString *_actionLogType;
  BOOL _collapsible;
}
...
@property (readonly, copy, nonatomic) NSArray *textParts;
...
/* instance methods */
- (id)initWithMessage:(id)message title:(id)title textAttributes:(id)attributes textParts:(id)parts actionLogType:(id)type collapsible:(BOOL)collapsible hidden:(BOOL)hidden;
...
#endif /* IGDirectThreadActionLog_h */
