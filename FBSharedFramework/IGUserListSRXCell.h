...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGUserListSRXCell_h
#define IGUserListSRXCell_h
@import Foundation;
...
@interface IGUserListSRXCell : UICollectionViewCell<IGUserListSelectableCellType> {
  ...
  IGTextButton *_selectButton;
  IGTextButton *_unselectButton;
  BOOL _isUserSelected;
}

@property (weak, nonatomic) NSObject<IGUserListSRXSelectionDelegate> *delegate;
