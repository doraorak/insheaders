...
//    - LC_SOURCE_VERSION: 
//
#ifndef FNFDashLiveRepresentation_h
#define FNFDashLiveRepresentation_h
@import Foundation;

#include "FNFDashLiveTimelineList.h"
...
@interface FNFDashLiveRepresentation : NSObject {
  /* instance variables */
  ...
  BOOL _trackMetadataIsFinal;
  BOOL _hasSeen410Segment;
  BOOL _removePredictiveUntilManifestUpdate;
  BOOL _latencyMitigationEnabled;
  BOOL _hasExperiencedStall;
  unsigned int _bandwidth;
  int _maxBandwidthCorrection;
  BOOL _dynamicQualityDropped;
...
- (double)getTimeToTimelineHead:(struct { long long x0; int x1; unsigned int x2; long long x3; })head;
- (long long)latestSegmentAvailable;
- (BOOL)_isPredictive;
- (int)_numPredictiveSegmentsWithCorrection;
- (int)_predictiveNumberForSequenceIndex:(int)index;
- (id)_predictiveSegmentForSequenceIndex:(int)index;
- (struct { long long x0; int x1; unsigned int x2; long long x3; })_durationToPredictiveSequenceIndex:(int)index;
- (int)_predictiveSequenceIndexForTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })time;
- (double)_secondsFromLiveHeadToStartPlayback;
- (BOOL)_catchupWithPlaybackTime:(struct { long long x0; int x1; unsigned int x2; long long x3; })time;
...
#endif /* FNFDashLiveRepresentation_h */
