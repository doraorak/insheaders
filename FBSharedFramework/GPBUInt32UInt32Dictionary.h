...
//    - LC_SOURCE_VERSION: 
//
#ifndef GPBUInt32UInt32Dictionary_h
#define GPBUInt32UInt32Dictionary_h
@import Foundation;
...
- (BOOL)getUInt32:(unsigned int *)uint32 forKey:(unsigned int)key;
...
#endif /* GPBUInt32UInt32Dictionary_h */
