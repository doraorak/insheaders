...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGFanClubTeaserStoryItem_h
#define IGFanClubTeaserStoryItem_h
@import Foundation;
...
@interface IGFanClubTeaserStoryItem : NSObject<IGStoryItemType, IGUnitItemInformationProviding> {
  /* instance variables */
  IGUser *_creatorUser;
  IGDate *_takenAtDate;
}
...
/* instance methods */
- (id)initWithCreatorUser:(id)user takenAtDate:(id)date;
- (id)unitItemId;
...
#endif /* IGFanClubTeaserStoryItem_h */
