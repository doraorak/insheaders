...
//    - LC_SOURCE_VERSION: 
//
#ifndef FNFDashWebmChunk_h
#define FNFDashWebmChunk_h
@import Foundation;

#include "FNFDashFetchRange.h"
#include "FNFDashWebmHeader.h"

@class NSString;
@protocol {FNFDashWebmCluster="_vptr$Callback"^^?"_reader"{ThinReader="_vptr$Reader"^^?"_stream_offset"Q"_num_bytes_remaining"Q"_buffer"*}"_parser"{Parser="_stack"^{Frame}"_block_head"^{BlockHead}}"_frames"{queue<std::tuple<unsigned long long, unsigned long long, unsigned long long, bool, std::vector<unsigned char>>, std::deque<std::tuple<unsigned long long, unsigned long long, unsigned long long, bool, std::vector<unsigned char>>>>="c"{deque<std::tuple<unsigned long long, unsigned long long, unsigned long long, bool, std::vector<unsigned char>>, std::allocator<std::tuple<unsigned long long, unsigned long long, unsigned long long, bool, std::vector<unsigned char>>>>="__map_"{__split_buffer<std::tuple<unsigned long long, unsigned long long, unsigned long long, bool, std::vector<unsigned char>> *, std::allocator<std::tuple<unsigned long long, unsigned long long, unsigned long long, bool, std::vector<unsigned char>> *>>="__first_"^^v"__begin_"^^v"__end_"^^v"__end_cap_"{__compressed_pair<std::tuple<unsigned long long, unsigned long long, unsigned long long, bool, std::vector<unsigned char>> **, std::allocator<std::tuple<unsigned long long, unsigned long long, unsigned long long, bool, std::vector<unsigned char>> *>>="__value_"^^v}}"__start_"Q"__size_"{__compressed_pair<unsigned long, std::allocator<std::tuple<unsigned long long, unsigned long long, unsigned long long, bool, std::vector<unsigned char>>>>="__value_"Q}}}"_block_timecode"I"_is_key_frame"B"_current_frame_index"Q"_current_frame_count"Q};

@interface FNFDashWebmChunk : NSObject {
  /* instance variables */
  unsigned long long _fetchState;
  FNFDashWebmHeader *_header;
  struct FNFDashWebmCluster { undefined * *_vptr$Callback; struct ThinReader { undefined * *_vptr$Reader; unsigned long long _stream_offset; unsigned long long _num_bytes_remaining; char *_buffer; } _reader; struct Parser { struct Frame *_stack; struct BlockHead *_block_head; } _parser; struct queue<std::tuple<unsigned long long, unsigned long long, unsigned long long, bool, std::vector<unsigned char>>, std::deque<std::tuple<unsigned long long, unsigned long long, unsigned long long, bool, std::vector<unsigned char>>>> { struct deque<std::tuple<unsigned long long, unsigned long long, unsigned long long, bool, std::vector<unsigned char>>, std::allocator<std::tuple<unsigned long long, unsigned long long, unsigned long long, bool, std::vector<unsigned char>>>> { struct __split_buffer<std::tuple<unsigned long long, unsigned long long, unsigned long long, bool, std::vector<unsigned char>> *, std::allocator<std::tuple<unsigned long long, unsigned long long, unsigned long long, bool, std::vector<unsigned char>> *>> { void * *__first_; void * *__begin_; void * *__end_; struct __compressed_pair<std::tuple<unsigned long long, unsigned long long, unsigned long long, bool, std::vector<unsigned char>> **, std::allocator<std::tuple<unsigned long long, unsigned long long, unsigned long long, bool, std::vector<unsigned char>> *>> { void * *__value_; } __end_cap_; } __map_; unsigned long long __start_; struct __compressed_pair<unsigned long, std::allocator<std::tuple<unsigned long long, unsigned long long, unsigned long long, bool, std::vector<unsigned char>>>> { unsigned long long __value_; } __size_; } c; } _frames; unsigned int _block_timecode; BOOL _is_key_frame; unsigned long long _current_frame_index; unsigned long long _current_frame_count; } _cluster;
