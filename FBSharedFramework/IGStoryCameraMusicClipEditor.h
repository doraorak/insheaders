...
@interface IGStoryCameraMusicClipEditor : UIViewController<IGPartialModalSheetListener, IGGestureHandler> {
  /* instance variables */
  ...
  BOOL _isARAudioEffectDataRequired;
...
@property (weak, nonatomic) NSObject<IGStoryCameraMusicClipEditorDelegate> *delegate;
...
/* instance methods */
- (id)initWithMusicTrackClip:(id)clip musicBrowserViewController:(id)controller userSession:(id)session maxClipDuration:(double)duration;
- (void)viewDidLoad;
...
#endif /* IGStoryCameraMusicClipEditor_h */
