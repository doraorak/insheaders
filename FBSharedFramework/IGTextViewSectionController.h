...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGTextViewSectionController_h
#define IGTextViewSectionController_h
@import Foundation;
...
@property (readonly, nonatomic) NSObject<IGTextViewItemViewModelProtocol> *viewModel;
@property (weak, nonatomic) NSObject<IGTextViewSectionControllerDelegate> *delegate;
...
#endif /* IGTextViewSectionController_h */
