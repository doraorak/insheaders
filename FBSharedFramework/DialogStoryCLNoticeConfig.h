...
//    - LC_SOURCE_VERSION: 
//
#ifndef DialogStoryCLNoticeConfig_h
#define DialogStoryCLNoticeConfig_h
@import Foundation;
...
@interface DialogStoryCLNoticeConfig : NSObject<CLNoticeConfig>
...
#endif /* DialogStoryCLNoticeConfig_h */
