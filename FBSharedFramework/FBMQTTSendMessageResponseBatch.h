...
//    - LC_SOURCE_VERSION: 
//
#ifndef FBMQTTSendMessageResponseBatch_h
#define FBMQTTSendMessageResponseBatch_h
@import Foundation;
...
/* instance methods */
- (id)init;
- (id)initWithBatchId:(long long)id fbTraceMeta:(id)meta responses:(id)responses supported:(BOOL)supported;
...
#endif /* FBMQTTSendMessageResponseBatch_h */
