...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGSundialDraftStoreSQLiteImpl_h
#define IGSundialDraftStoreSQLiteImpl_h
@import Foundation;
...
#include "IGSundialDraftStoreSQLiteCompositionManager.h"
#include "IGSundialDraftStoreV2Protocol-Protocol.h"
#include "IGUserSession.h"

@class NSMutableDictionary, NSString;

@interface IGSundialDraftStoreSQLiteImpl : NSObject<IGSQLiteDatabaseDelegate, IGSundialDraftStoreProtocol, IGSundialDraftStoreV2Protocol> {
  /* instance variables */
  IGUserSession *_userSession;
  IGSQLiteDatabase *_database;
  IGSundialDraftStoreSQLiteCompositionManager *_compositionManager;
  NSMutableDictionary *_resourceDirectoryForDraftType;
  NSMutableDictionary *_savedDraftsForDraftType;
  NSMutableDictionary *_previewImageCacheForDraftType;
  NSMutableDictionary *_draftPostObserversForDraftType;
  NSMutableDictionary *_lastDraftRestoreErrorForDraftType;
  NSMutableDictionary *_lastDraftSaveErrorForDraftType;
  NSMutableDictionary *_eventAnnoucerForDraftType;
  NSMutableDictionary *_undodRedoEventAnnouncer;
...
#endif /* IGSundialDraftStoreSQLiteImpl_h */
