...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGDirectComposerAddYoursModel_h
#define IGDirectComposerAddYoursModel_h
@import Foundation;
...
@interface IGDirectComposerAddYoursModel : NSObject<IGListDiffable, IGStickerModelType, IGSmartStickerModelType, NSSecureCoding>
...
#endif /* IGDirectComposerAddYoursModel_h */
