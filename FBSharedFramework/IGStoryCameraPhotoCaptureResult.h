...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGStoryCameraPhotoCaptureResult_h
#define IGStoryCameraPhotoCaptureResult_h
@import Foundation;
...
@interface IGStoryCameraPhotoCaptureResult : NSObject<METAMediaAsset, IGStoryMediaAsset> {
  /* instance variables */
  IGUserSession *_userSession;
}

@property (readonly, nonatomic) IGAsyncTask *imageCreationTask;
...
/* instance methods */
- (id)initWithImageCreationTask:(id)task imageSize:(struct CGSize { double x0; double x1; })size previewImage:(id)image;
- (id)initWithImageCreationTask:(id)task imageSize:(struct CGSize { double x0; double x1; })size previewImage:(id)image userSession:(id)session;
...
#endif /* IGStoryCameraPhotoCaptureResult_h */
