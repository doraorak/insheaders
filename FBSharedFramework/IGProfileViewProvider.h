...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGProfileViewProvider_h
#define IGProfileViewProvider_h
@import Foundation;

#include "IGProfileCellBodyView.h"
#include "IGProfilePictureImageView.h"
#include "IGProfileViewModel.h"
...
@interface IGProfileViewProvider : NSObject<NSObject> {
  /* instance variables */
  IGProfilePictureImageView *_profileImageView;
  IGProfileCellBodyView *_bodyView;
}

@property (retain, nonatomic) IGProfileViewModel *viewModel;
