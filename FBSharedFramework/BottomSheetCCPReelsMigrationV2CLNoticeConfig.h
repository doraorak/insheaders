...
//    - LC_SOURCE_VERSION: 
//
#ifndef BottomSheetCCPReelsMigrationV2CLNoticeConfig_h
#define BottomSheetCCPReelsMigrationV2CLNoticeConfig_h
@import Foundation;
...
@interface BottomSheetCCPReelsMigrationV2CLNoticeConfig : NSObject<CLNoticeConfig> {
  /* instance variables */
...
#endif /* BottomSheetCCPReelsMigrationV2CLNoticeConfig_h */
