...
//    - LC_SOURCE_VERSION: 
//
#ifndef GPBUInt32Int64Dictionary_h
#define GPBUInt32Int64Dictionary_h
@import Foundation;
...
/* instance methods */
- (id)init;
- (id)initWithInt64s:(const long long *)int64s forKeys:(const unsigned int *)keys count:(unsigned long long)count;
...
- (BOOL)getInt64:(long long *)int64 forKey:(unsigned int)key;
- (void)addEntriesFromDictionary:(id)dictionary;
- (void)setInt64:(long long)int64 forKey:(unsigned int)key;
- (void)removeInt64ForKey:(unsigned int)key;
- (void)removeAll;
@end

#endif /* GPBUInt32Int64Dictionary_h */
