...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGFNFBusyHourQualitySelector_h
#define IGFNFBusyHourQualitySelector_h
@import Foundation;

#include "FNFDashPlaylist.h"
#include "FNFDashQualitySelecting-Protocol.h"
#include "IGUserLauncherSetProviding-Protocol.h"

@class NSString;

@interface IGFNFBusyHourQualitySelector : NSObject<FNFDashQualitySelecting> {
  /* instance variables */
  FNFDashPlaylist *_playlist;
  long long _trackType;
  NSObject<IGUserLauncherSetProviding> *_launcherSetProvider;
  NSObject<FNFDashQualitySelecting> *_fallbackSelector;
}
