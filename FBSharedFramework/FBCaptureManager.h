...
//    - LC_SOURCE_VERSION: 
//
#ifndef FBCaptureManager_h
#define FBCaptureManager_h
@import Foundation;
...
@interface FBCaptureManager : NSObject<AVCaptureVideoDataOutputSampleBufferDelegate, FBMPCameraCaptureInput, FBCaptureCameraController, FBARCameraCapabilitiesProviding> {
  /* instance variables */
