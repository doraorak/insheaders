...
//    - LC_SOURCE_VERSION: 
//
#ifndef GPBUInt64Int32Dictionary_h
#define GPBUInt64Int32Dictionary_h
@import Foundation;
...
/* instance methods */
- (id)init;
- (id)initWithInt32s:(const int *)int32s forKeys:(const unsigned long long *)keys count:(unsigned long long)count;
...
- (BOOL)getInt32:(int *)int32 forKey:(unsigned long long)key;
- (void)addEntriesFromDictionary:(id)dictionary;
- (void)setInt32:(int)int32 forKey:(unsigned long long)key;
- (void)removeInt32ForKey:(unsigned long long)key;
- (void)removeAll;
@end

#endif /* GPBUInt64Int32Dictionary_h */
