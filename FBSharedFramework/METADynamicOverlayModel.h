...
//    - LC_SOURCE_VERSION: 
//
#ifndef METADynamicOverlayModel_h
#define METADynamicOverlayModel_h
@import Foundation;
...
@interface METADynamicOverlayModel : NSObject<NSSecureCoding>
...
#endif /* METADynamicOverlayModel_h */
