...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGStoryMusicAlbumArtStickerView_h
#define IGStoryMusicAlbumArtStickerView_h
@import Foundation;

#include "UIView.h"
#include "IGAudioMusicTrack.h"
#include "IGBigAlbumArtMusicSticker.h"
...
@interface IGStoryMusicAlbumArtStickerView : UIView<IGStickerViewType, IGStoryMusicStickerProtocol, IGDynamicSurfaceStickerViewType, IGConstrainedZPositionStickerViewType, IGStoryStickerDeletable> {
  /* instance variables */
...
#endif /* IGStoryMusicAlbumArtStickerView_h */
