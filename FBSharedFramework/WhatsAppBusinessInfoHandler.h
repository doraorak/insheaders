...
//    - LC_SOURCE_VERSION: 
//
#ifndef WhatsAppBusinessInfoHandler_h
#define WhatsAppBusinessInfoHandler_h
@import Foundation;
...
@interface WhatsAppBusinessInfoHandler : NSObject<BusinessInfoHandler> {
  /* instance variables */
...
#endif /* WhatsAppBusinessInfoHandler_h */
