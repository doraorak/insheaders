...
//    - LC_SOURCE_VERSION: 
//
#ifndef GPBStringDoubleDictionary_h
#define GPBStringDoubleDictionary_h
@import Foundation;
...
/* instance methods */
- (id)init;
- (id)initWithDoubles:(const double *)doubles forKeys:(id *)keys count:(unsigned long long)count;
...
- (void)removeDoubleForKey:(id)key;
- (void)removeAll;
@end

#endif /* GPBStringDoubleDictionary_h */
