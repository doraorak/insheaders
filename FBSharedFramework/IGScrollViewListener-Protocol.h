...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGScrollViewListener_Protocol_h
#define IGScrollViewListener_Protocol_h
@import Foundation;

@protocol IGScrollViewListener <NSObject>
@optional
/* instance methods */
...
#endif /* IGScrollViewListener_Protocol_h */
