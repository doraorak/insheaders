...
//    - LC_SOURCE_VERSION: 
//
#ifndef FBWatchdogEventHandler_h
#define FBWatchdogEventHandler_h
@import Foundation;
...
@interface FBWatchdogEventHandler : NSObject<FBWatchdogExpiryHandling> {
  /* instance variables */
...
#endif /* FBWatchdogEventHandler_h */
