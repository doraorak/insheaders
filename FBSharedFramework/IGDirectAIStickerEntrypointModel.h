...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGDirectAIStickerEntrypointModel_h
#define IGDirectAIStickerEntrypointModel_h
@import Foundation;
...
@interface IGDirectAIStickerEntrypointModel : NSObject<IGListDiffable, IGStickerModelType, IGSmartStickerModelType, NSSecureCoding>
...
#endif /* IGDirectAIStickerEntrypointModel_h */
