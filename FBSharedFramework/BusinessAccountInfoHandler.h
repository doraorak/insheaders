...
//    - LC_SOURCE_VERSION: 
//
#ifndef BusinessAccountInfoHandler_h
#define BusinessAccountInfoHandler_h
@import Foundation;
...
@interface BusinessAccountInfoHandler : NSObject<BusinessInfoHandler> {
  /* instance variables */
...
#endif /* BusinessAccountInfoHandler_h */
