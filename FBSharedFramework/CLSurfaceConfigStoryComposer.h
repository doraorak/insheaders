...
//    - LC_SOURCE_VERSION: 
//
#ifndef CLSurfaceConfigStoryComposer_h
#define CLSurfaceConfigStoryComposer_h
@import Foundation;
...
@interface CLSurfaceConfigStoryComposer : NSObject<NSObject>
...
#endif /* CLSurfaceConfigStoryComposer_h */
