...
//    - LC_SOURCE_VERSION: 
//
#ifndef GPBUInt64UInt64Dictionary_h
#define GPBUInt64UInt64Dictionary_h
@import Foundation;
...
/* instance methods */
- (id)init;
- (id)initWithUInt64s:(const unsigned long long *)uint64s forKeys:(const unsigned long long *)keys count:(unsigned long long)count;
...
- (BOOL)getUInt64:(unsigned long long *)uint64 forKey:(unsigned long long)key;
- (void)addEntriesFromDictionary:(id)dictionary;
- (void)setUInt64:(unsigned long long)uint64 forKey:(unsigned long long)key;
- (void)removeUInt64ForKey:(unsigned long long)key;
- (void)removeAll;
@end

#endif /* GPBUInt64UInt64Dictionary_h */
