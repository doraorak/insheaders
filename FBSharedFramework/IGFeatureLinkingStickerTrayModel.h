...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGFeatureLinkingStickerTrayModel_h
#define IGFeatureLinkingStickerTrayModel_h
@import Foundation;
...
@interface IGFeatureLinkingStickerTrayModel : NSObject<IGListDiffable, IGStickerModelType, IGSmartStickerModelType, NSCoding>
...
#endif /* IGFeatureLinkingStickerTrayModel_h */
