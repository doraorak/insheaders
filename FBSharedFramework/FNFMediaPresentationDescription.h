...
@property (readonly, nonatomic) BOOL isManifestService;
@property (readonly, nonatomic) unsigned long long source;
@property (readonly, nonatomic) BOOL containsUsingASRCaptions;
@property (readonly, nonatomic) unsigned long long timelineType;
@property (readonly, nonatomic) unsigned int durationMS;
@property (readonly, nonatomic) long long videoType;
@property (readonly, nonatomic) double publishFrameTimeMS;
@property (readonly, nonatomic) long long minimumUpdatePeriodMs;
@property (readonly, copy, nonatomic) NSString *mpdAccessibilityDescription;
@property (readonly, copy, nonatomic) NSDate *availabilityEndTime;
@property (readonly, copy, nonatomic) NSDate *publishTime;
@property (readonly, nonatomic) long long firstAvTimeMS;
@property (readonly, nonatomic) long long currentServerTimeMs;
@property (readonly, nonatomic) long long lastVideoFrameTimeMs;
