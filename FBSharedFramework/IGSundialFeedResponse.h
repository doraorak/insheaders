...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGSundialFeedResponse_h
#define IGSundialFeedResponse_h
@import Foundation;
...
@interface IGSundialFeedResponse : NSObject<IGFeedNetworkSourceParsedResponse>
...
/* instance methods */
- (id)initWithNextMaxID:(id)id downloadedItems:(id)items sponsoredItems:(id)items chunkIndex:(long long)index rawResponseData:(id)data isLoadedFromNetworkCache:(BOOL)cache shouldClearOutExistingFeed:(BOOL)feed;
- (BOOL)shouldUpdatePaging;
@end

#endif /* IGSundialFeedResponse_h */
