...
//    - LC_SOURCE_VERSION: 
//
#ifndef GPBInt32DoubleDictionary_h
#define GPBInt32DoubleDictionary_h
@import Foundation;
...
/* instance methods */
- (id)init;
- (id)initWithDoubles:(const double *)doubles forKeys:(const int *)keys count:(unsigned long long)count;
...
#endif /* GPBInt32DoubleDictionary_h */
