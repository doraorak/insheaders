...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGAudioBrowserMultiTrackCellSectionController_h
#define IGAudioBrowserMultiTrackCellSectionController_h
@import Foundation;
...
@class NSString;
@protocol IGAudioBrowserMultiTrackCellSectionControllerDelegate;

@interface IGAudioBrowserMultiTrackCellSectionController : IGListBindingSectionController<IGListBindingSectionControllerDataSource, IGListBindingSectionControllerSelectionDelegate>

@property (weak, nonatomic) NSObject<IGAudioBrowserMultiTrackCellSectionControllerDelegate> *delegate;
...
- (void)audioBrowserMultiTrackCellDidTapSingleCell:(id)cell;
@end

#endif /* IGAudioBrowserMultiTrackCellSectionController_h */
