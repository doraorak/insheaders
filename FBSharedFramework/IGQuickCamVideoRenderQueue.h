...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGQuickCamVideoRenderQueue_h
#define IGQuickCamVideoRenderQueue_h
@import Foundation;
...
@interface IGQuickCamVideoRenderQueue : NSObject<IGVideoRendererListener> {
  /* instance variables */
  NSMutableArray *_renderQueue;
  NSMutableArray *_completionBlocks;
  id /* block */ _progressUpdatesBlock;
}
...
#endif /* IGQuickCamVideoRenderQueue_h */
