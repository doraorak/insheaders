...
//    - LC_SOURCE_VERSION: 
//
#ifndef GPBInt32ObjectDictionary_h
#define GPBInt32ObjectDictionary_h
@import Foundation;
...
/* instance methods */
- (id)init;
- (id)initWithObjects:(const id *)objects forKeys:(const int *)keys count:(unsigned long long)count;
...
#endif /* GPBInt32ObjectDictionary_h */
