...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGStoryMediaCompositionViewDelegate_Protocol_h
#define IGStoryMediaCompositionViewDelegate_Protocol_h
@import Foundation;
...
#endif /* IGStoryMediaCompositionViewDelegate_Protocol_h */
