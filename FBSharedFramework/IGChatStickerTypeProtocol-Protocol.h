...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGChatStickerTypeProtocol_Protocol_h
#define IGChatStickerTypeProtocol_Protocol_h
@import Foundation;

@protocol IGChatStickerTypeProtocol <NSObject>
...
#endif /* IGChatStickerTypeProtocol_Protocol_h */
