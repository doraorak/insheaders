...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGOctaneFirstMessageState_h
#define IGOctaneFirstMessageState_h
@import Foundation;
...
@interface IGOctaneFirstMessageState : NSObject<NSObject>
...
#endif /* IGOctaneFirstMessageState_h */
