...
//    - LC_SOURCE_VERSION: 
//
#ifndef FNFDecompressionSessionForAV01_h
#define FNFDecompressionSessionForAV01_h
@import Foundation;
...
@interface FNFDecompressionSessionForAV01 : NSObject<FNFDecompressionSession> {
  /* instance variables */
  NSObject<FNFDecompressionSession> *_activeDecompressionSession;
}
...
#endif /* FNFDecompressionSessionForAV01_h */
