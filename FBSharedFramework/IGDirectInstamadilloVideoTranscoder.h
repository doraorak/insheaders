...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGDirectInstamadilloVideoTranscoder_h
#define IGDirectInstamadilloVideoTranscoder_h
@import Foundation;

#include "IGDInstamadilloVideoTranscoding-Protocol.h"
...
@interface IGDirectInstamadilloVideoTranscoder : NSObject<IGVideoRendererListener, IGDInstamadilloVideoTranscoding> {
  /* instance variables */
...
#endif /* IGDirectInstamadilloVideoTranscoder_h */
