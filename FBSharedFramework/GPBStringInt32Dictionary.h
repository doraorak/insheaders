...
//    - LC_SOURCE_VERSION: 
//
#ifndef GPBStringInt32Dictionary_h
#define GPBStringInt32Dictionary_h
@import Foundation;
...
/* instance methods */
- (id)init;
- (id)initWithInt32s:(const int *)int32s forKeys:(id *)keys count:(unsigned long long)count;
...
- (void)removeInt32ForKey:(id)key;
- (void)removeAll;
@end

#endif /* GPBStringInt32Dictionary_h */
