...
- (BOOL)layoutManager:(id)manager shouldSetLineFragmentRect:(inout struct CGRect *)rect lineFragmentUsedRect:(inout struct CGRect *)rect baselineOffset:(inout double *)offset inTextContainer:(id)container forGlyphRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })range;
