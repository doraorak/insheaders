...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGVideoUploadTaskHolder_h
#define IGVideoUploadTaskHolder_h
@import Foundation;
...
@interface IGVideoUploadTaskHolder : NSObject<IGUploadTaskListener, IGVideoUploadTaskType> {
  /* instance variables */
  NSObject<IGUploadTaskType> *_task;
  NSDictionary *_videoCoverPhotoUploadResponse;
...
- (id)videoCoverPhotoUploadResponse;
- (id)taskId;
- (id)uploadId;
...
#endif /* IGVideoUploadTaskHolder_h */
