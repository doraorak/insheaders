...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGGenAIImageExpanderRequestResolver_h
#define IGGenAIImageExpanderRequestResolver_h
@import Foundation;

#include "IGAsyncTask.h"
#include "IGGenAIImageExpanderRequest.h"
...
@interface IGGenAIImageExpanderRequestResolver : NSObject<IGGenAIImageRequestResolver> {
  /* instance variables */
  IGUserSession *_session;
  IGGenAIImageExpanderRequest *_request;
...
#endif /* IGGenAIImageExpanderRequestResolver_h */
