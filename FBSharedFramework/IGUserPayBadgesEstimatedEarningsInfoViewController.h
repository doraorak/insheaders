...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGUserPayBadgesEstimatedEarningsInfoViewController_h
#define IGUserPayBadgesEstimatedEarningsInfoViewController_h
@import Foundation;
...
@interface IGUserPayBadgesEstimatedEarningsInfoViewController : UIViewController<IGGestureHandler, IGPartialModalSheetListener> {
  /* instance variables */
  UILabel *_infoLabel;
}
...
#endif /* IGUserPayBadgesEstimatedEarningsInfoViewController_h */
