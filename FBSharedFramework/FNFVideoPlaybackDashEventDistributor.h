...
//    - LC_SOURCE_VERSION: 
//
#ifndef FNFVideoPlaybackDashEventDistributor_h
#define FNFVideoPlaybackDashEventDistributor_h
@import Foundation;
...
@interface FNFVideoPlaybackDashEventDistributor : NSObject<FNFDashEventListener> {
  /* instance variables */
...
/* instance methods */
- (id)initWithDashEventListener:(id)listener fnfDashEventListener:(id)listener;
...
#endif /* FNFVideoPlaybackDashEventDistributor_h */
