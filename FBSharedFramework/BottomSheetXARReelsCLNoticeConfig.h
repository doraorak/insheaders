...
//    - LC_SOURCE_VERSION: 
//
#ifndef BottomSheetXARReelsCLNoticeConfig_h
#define BottomSheetXARReelsCLNoticeConfig_h
@import Foundation;
...
@interface BottomSheetXARReelsCLNoticeConfig : NSObject<CLNoticeConfig> {
  /* instance variables */
...
#endif /* BottomSheetXARReelsCLNoticeConfig_h */
