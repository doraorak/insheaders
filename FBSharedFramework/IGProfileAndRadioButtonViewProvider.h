...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGProfileAndRadioButtonViewProvider_h
#define IGProfileAndRadioButtonViewProvider_h
@import Foundation;
...
@interface IGProfileAndRadioButtonViewProvider : NSObject<NSObject> {
  /* instance variables */
  IGProfilePictureImageView *_profileImageView;
  IGProfileCellBodyView *_bodyView;
  IGRadioButton *_radioButton;
  NSObject<IGProfileAndRadioButtonViewDelegate> *_delegate;
}
...
#endif /* IGProfileAndRadioButtonViewProvider_h */
