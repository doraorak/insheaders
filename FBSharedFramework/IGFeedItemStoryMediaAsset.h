...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGFeedItemStoryMediaAsset_h
#define IGFeedItemStoryMediaAsset_h
@import Foundation;
...
@interface IGFeedItemStoryMediaAsset : NSObject<METAMediaAsset, IGStoryMediaAsset> {
  /* instance variables */
  IGMedia *_media;
...
- (id)initWithMedia:(id)media userSession:(id)session selectedPost:(id)post;
- (id)renderer;
...
#endif /* IGFeedItemStoryMediaAsset_h */
