...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGAIStickerModel_h
#define IGAIStickerModel_h
@import Foundation;
...
@interface IGAIStickerModel : NSObject<IGListDiffable, IGStickerModelType, IGSmartStickerModelType, NSSecureCoding>
