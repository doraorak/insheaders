...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGLiveUserPayBadgePurchaseAnimationController_h
#define IGLiveUserPayBadgePurchaseAnimationController_h
@import Foundation;
...
#endif /* IGLiveUserPayBadgePurchaseAnimationController_h */
