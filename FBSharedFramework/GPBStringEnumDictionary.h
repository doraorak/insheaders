...
//    - LC_SOURCE_VERSION: 
//
#ifndef GPBStringEnumDictionary_h
#define GPBStringEnumDictionary_h
@import Foundation;
...
- (id)initWithValidationFunction:(undefined *)function rawValues:(const int *)values forKeys:(id *)keys count:(unsigned long long)count;
...
#endif /* GPBStringEnumDictionary_h */
