...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGListAdapter_CollectionViewLayoutDataSource_h
#define IGListAdapter_CollectionViewLayoutDataSource_h
@import Foundation;

@interface IGListAdapter (CollectionViewLayoutDataSource) <IGCollectionViewLayoutDataSource>
/* instance methods */
...
#endif /* IGListAdapter_CollectionViewLayoutDataSource_h */
