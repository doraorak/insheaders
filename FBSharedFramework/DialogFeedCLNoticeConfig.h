...
//    - LC_SOURCE_VERSION: 
//
#ifndef DialogFeedCLNoticeConfig_h
#define DialogFeedCLNoticeConfig_h
@import Foundation;
...
@interface DialogFeedCLNoticeConfig : NSObject<CLNoticeConfig>
...
#endif /* DialogFeedCLNoticeConfig_h */
