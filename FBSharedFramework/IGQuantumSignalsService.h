...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGQuantumSignalsService_h
#define IGQuantumSignalsService_h
@import Foundation;

#include "IGQuantumSignalsModelBuilder.h"
#include "IGQuantumSignalsServiceProviding-Protocol.h"
#include "IGUserLauncherSetProviding-Protocol.h"

@class NSString;
@protocol IGQuantumSignalsAnnouncer;

@interface IGQuantumSignalsService : NSObject<IGQuantumSignalsServiceProviding> {
  /* instance variables */
  NSObject<IGQuantumSignalsAnnouncer> *_announcer;
...
- (void)logExternalEventWithContainerModule:(id)module itemType:(unsigned long long)type itemId:(id)id;
- (void)scopeWillEnd;
@end

#endif /* IGQuantumSignalsService_h */
