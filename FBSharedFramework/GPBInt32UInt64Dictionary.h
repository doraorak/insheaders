...
//    - LC_SOURCE_VERSION: 
//
#ifndef GPBInt32UInt64Dictionary_h
#define GPBInt32UInt64Dictionary_h
@import Foundation;
...
/* instance methods */
- (id)init;
- (id)initWithUInt64s:(const unsigned long long *)uint64s forKeys:(const int *)keys count:(unsigned long long)count;
...
- (BOOL)getUInt64:(unsigned long long *)uint64 forKey:(int)key;
- (void)addEntriesFromDictionary:(id)dictionary;
- (void)setUInt64:(unsigned long long)uint64 forKey:(int)key;
- (void)removeUInt64ForKey:(int)key;
- (void)removeAll;
@end

#endif /* GPBInt32UInt64Dictionary_h */
