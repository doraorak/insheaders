...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGUserListToggleCollectionCell_h
#define IGUserListToggleCollectionCell_h
@import Foundation;
...
@class NSString;
@protocol IGUserListToggleCollectionCellDelegate;

@interface IGUserListToggleCollectionCell : UICollectionViewCell<_TtP22IGUserContentViewSwift25IGUserContentViewDelegate_, IGUserListSelectableCellType> {
  /* instance variables */
  BOOL _userSelected;
...
@property (weak, nonatomic) NSObject<IGUserListToggleCollectionCellDelegate> *delegate;
...
#endif /* IGUserListToggleCollectionCell_h */
