...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGResearchPollStoryItem_h
#define IGResearchPollStoryItem_h
@import Foundation;
...
@interface IGResearchPollStoryItem : NSObject<IGStoryItemType, IGUnitItemInformationProviding> {
  /* instance variables */
  NSString *_surveyID;
}
...
#endif /* IGResearchPollStoryItem_h */
