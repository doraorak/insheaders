...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGLabelSupplementaryViewSource_h
#define IGLabelSupplementaryViewSource_h
@import Foundation;
...
@property (retain, nonatomic) NSString *labelTitle;
@property (retain, nonatomic) IGLabelItemConfiguration *config;
...
#endif /* IGLabelSupplementaryViewSource_h */
