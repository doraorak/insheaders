...
//    - LC_SOURCE_VERSION: 
//
#ifndef GPBInt64Int64Dictionary_h
#define GPBInt64Int64Dictionary_h
@import Foundation;
...
/* instance methods */
- (id)init;
- (id)initWithInt64s:(const long long *)int64s forKeys:(const long long *)keys count:(unsigned long long)count;
...
- (BOOL)getInt64:(long long *)int64 forKey:(long long)key;
- (void)addEntriesFromDictionary:(id)dictionary;
- (void)setInt64:(long long)int64 forKey:(long long)key;
- (void)removeInt64ForKey:(long long)key;
- (void)removeAll;
@end

#endif /* GPBInt64Int64Dictionary_h */
