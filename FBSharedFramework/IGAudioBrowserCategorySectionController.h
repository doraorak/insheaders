...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGAudioBrowserCategorySectionController_h
#define IGAudioBrowserCategorySectionController_h
@import Foundation;

#include "IGListBindingSectionController.h"
#include "IGAsyncTask.h"
#include "IGAudioBrowserGenre.h"
...
@class NSString;
@protocol IGAudioBrowserCategorySectionControllerDelegate;

@interface IGAudioBrowserCategorySectionController : IGListBindingSectionController<IGListDisplayDelegate, IGListBindingSectionControllerDataSource, IGListBindingSectionControllerSelectionDelegate, IGAudioBrowserModelsListViewControllerDelegate> {
  /* instance variables */
  IGUserSession *_userSession;
  NSObject<IGAudioBrowserLogger> *_logger;
  IGAudioBrowserGenre *_genre;
  IGAsyncTask *_tracksForGenreRequest;
  BOOL _shouldUpdateThemeBasedOnTraitCollection;
  long long _uiInterfaceStyle;
}

@property (weak, nonatomic) NSObject<IGAudioBrowserCategorySectionControllerDelegate> *delegate;
...
#endif /* IGAudioBrowserCategorySectionController_h */
