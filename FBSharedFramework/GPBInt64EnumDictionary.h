...
//    - LC_SOURCE_VERSION: 
//
#ifndef GPBInt64EnumDictionary_h
#define GPBInt64EnumDictionary_h
@import Foundation;
...
- (id)initWithValidationFunction:(undefined *)function rawValues:(const int *)values forKeys:(const long long *)keys count:(unsigned long long)count;
...
- (BOOL)getEnum:(int *)enum forKey:(long long)key;
- (BOOL)getRawValue:(int *)value forKey:(long long)key;
- (void)enumerateKeysAndEnumsUsingBlock:(id /* block */)block;
- (void)addRawEntriesFromDictionary:(id)dictionary;
- (void)setRawValue:(int)value forKey:(long long)key;
- (void)removeEnumForKey:(long long)key;
- (void)removeAll;
- (void)setEnum:(int)enum forKey:(long long)key;
@end

#endif /* GPBInt64EnumDictionary_h */
