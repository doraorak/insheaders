...
//    - LC_SOURCE_VERSION: 
//
#ifndef GPBUInt32DoubleDictionary_h
#define GPBUInt32DoubleDictionary_h
@import Foundation;
...
/* instance methods */
- (id)init;
- (id)initWithDoubles:(const double *)doubles forKeys:(const unsigned int *)keys count:(unsigned long long)count;
...
#endif /* GPBUInt32DoubleDictionary_h */
