...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGFetchFromNetworkAndReturnCachedDataPolicy_h
#define IGFetchFromNetworkAndReturnCachedDataPolicy_h
@import Foundation;
...
@interface IGFetchFromNetworkAndReturnCachedDataPolicy : NSObject<IGCachePolicy> {
  ...
  BOOL _supports304;
  BOOL _shouldCacheFailedResponses;
}
...
- (id)initWithMetadata:(id)metadata support304:(BOOL)support304 cacheFailedResponses:(BOOL)responses;
- (id)metadata;
...
#endif /* IGFetchFromNetworkAndReturnCachedDataPolicy_h */
