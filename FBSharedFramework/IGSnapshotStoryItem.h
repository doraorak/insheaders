...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGSnapshotStoryItem_h
#define IGSnapshotStoryItem_h
@import Foundation;

#include "IGStoryItemType-Protocol.h"
#include "IGStorySnapshotData.h"
#include "IGUnitItemInformationProviding-Protocol.h"

@class NSString;

@interface IGSnapshotStoryItem : NSObject<IGStoryItemType, IGUnitItemInformationProviding>

@property (readonly, nonatomic) IGStorySnapshotData *snapshotData;
