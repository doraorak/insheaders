...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGFixedFrameLayout_h
#define IGFixedFrameLayout_h
@import Foundation;
...
/* class methods */
+ (id)newWithFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })frame child:(id)child;

/* instance methods */
- (id)initWithFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })frame child:(id)child;
