...
//    - LC_SOURCE_VERSION: 
//
#ifndef _TtC11MediaSource33MediaSourceAVCompositionValidator_h
#define _TtC11MediaSource33MediaSourceAVCompositionValidator_h
@import Foundation;

#include "AVVideoCompositionValidationHandling-Protocol.h"

@interface _TtC11MediaSource33MediaSourceAVCompositionValidator : NSObject<AVVideoCompositionValidationHandling> { // (Swift)
  /* instance variables */
   errors;
}
...
#endif /* _TtC11MediaSource33MediaSourceAVCompositionValidator_h */
