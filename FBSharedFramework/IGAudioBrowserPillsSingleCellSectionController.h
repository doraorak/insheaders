...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGAudioBrowserPillsSingleCellSectionController_h
#define IGAudioBrowserPillsSingleCellSectionController_h
@import Foundation;

#include "IGListBindingSectionController.h"
#include "IGAudioBrowserPillsSingleCellModel.h"
...
@class NSString;
@protocol IGAudioBrowserPillsSingleCellSectionControllerDelegate;

@interface IGAudioBrowserPillsSingleCellSectionController : IGListBindingSectionController<IGListBindingSectionControllerDataSource, IGListBindingSectionControllerSelectionDelegate> {
  /* instance variables */
  IGAudioBrowserPillsSingleCellModel *_pillsModel;
}

@property (weak, nonatomic) NSObject<IGAudioBrowserPillsSingleCellSectionControllerDelegate> *delegate;
...
#endif /* IGAudioBrowserPillsSingleCellSectionController_h */
