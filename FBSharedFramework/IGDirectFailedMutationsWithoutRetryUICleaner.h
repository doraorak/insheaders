...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGDirectFailedMutationsWithoutRetryUICleaner_h
#define IGDirectFailedMutationsWithoutRetryUICleaner_h
@import Foundation;
...
@interface IGDirectFailedMutationsWithoutRetryUICleaner : NSObject<NSObject> {
  /* instance variables */
...
/* instance methods */
- (id)initWithRequestStateStore:(id)store;
...
#endif /* IGDirectFailedMutationsWithoutRetryUICleaner_h */
