...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGChainingFeedSectionControllerContext_IGPlaybackCoordinator_h
#define IGChainingFeedSectionControllerContext_IGPlaybackCoordinator_h
@import Foundation;
...
@interface IGChainingFeedSectionControllerContext (IGPlaybackCoordinator)
/* instance methods */
- (id)playbackCoordinator;
@end

#endif /* IGChainingFeedSectionControllerContext_IGPlaybackCoordinator_h */
