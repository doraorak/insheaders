...
//    - LC_SOURCE_VERSION: 
//
#ifndef _TtC11ImageSource31ImageSourceBackgroundRenderView_h
#define _TtC11ImageSource31ImageSourceBackgroundRenderView_h
@import Foundation;
...
@interface _TtC11ImageSource31ImageSourceBackgroundRenderView : UIView<_TtP11ImageSource19ImageSourceViewType_> {
  /* instance variables */
   context;
   commandQueue;
   textureCache;
...
#endif /* _TtC11ImageSource31ImageSourceBackgroundRenderView_h */
