...
//    - LC_SOURCE_VERSION: 
//
#ifndef METACaptureManager_h
#define METACaptureManager_h
@import Foundation;
...
#include "_TtC14MetaCameraZoom19MetaCameraZoomCache.h"

@class AVCaptureAudioDataOutput, AVCaptureDevice, AVCaptureDeviceInput, AVCapturePhotoOutput, AVCaptureVideoPreviewLayer, FBCameraCaptureSystemPressureLevelAnnouncer, NSArray, NSDictionary, NSNumber, NSString;
...
@interface METACaptureManager : NSObject<AVCaptureVideoDataOutputSampleBufferDelegate, FBMPCameraCaptureInput, FBCaptureCameraController, FBARCameraCapabilitiesProviding> {
  /* instance variables */
  ...
  FBCameraCaptureSystemPressureLevelAnnouncer *_systemPressureLevelAnnouncer;
  ...
  _TtC14MetaCameraZoom19MetaCameraZoomCache *_zoomCache;
