...
- (id)initWithValues:(const BOOL *)values count:(unsigned long long)count;
...
- (BOOL)valueAtIndex:(unsigned long long)index;
- (void)internalResizeToCapacity:(unsigned long long)capacity;
- (void)addValue:(BOOL)value;
- (void)addValues:(const BOOL *)values count:(unsigned long long)count;
- (void)insertValue:(BOOL)value atIndex:(unsigned long long)index;
- (void)replaceValueAtIndex:(unsigned long long)index withValue:(BOOL)value;
