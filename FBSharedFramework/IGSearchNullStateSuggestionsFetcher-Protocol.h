...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGSearchNullStateSuggestionsFetcher_Protocol_h
#define IGSearchNullStateSuggestionsFetcher_Protocol_h
@import Foundation;
...
#endif /* IGSearchNullStateSuggestionsFetcher_Protocol_h */
