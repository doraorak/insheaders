...
//    - LC_SOURCE_VERSION: 
//
#ifndef CLSurfaceConfigFeedShareLater_h
#define CLSurfaceConfigFeedShareLater_h
@import Foundation;
...
@interface CLSurfaceConfigFeedShareLater : NSObject<NSObject>
...
#endif /* CLSurfaceConfigFeedShareLater_h */
