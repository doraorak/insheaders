...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGSimpleCrossfadeTransitionController_h
#define IGSimpleCrossfadeTransitionController_h
@import Foundation;
...
@interface IGSimpleCrossfadeTransitionController : NSObject<UIViewControllerTransitioningDelegate, UIViewControllerAnimatedTransitioning> {
  ...
  BOOL _crossfadePresentingViewController;
}
...
- (id)initWithDuration:(double)duration delay:(double)delay;
- (id)initWithPresentationDuration:(double)duration dismissalDuration:(double)duration delay:(double)delay;
...
#endif /* IGSimpleCrossfadeTransitionController_h */
