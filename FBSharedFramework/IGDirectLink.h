...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGDirectLink_h
#define IGDirectLink_h
@import Foundation;
...
@interface IGDirectLink : NSObject<IGDirectUIMessageProviding>

@property (readonly, nonatomic) IGDirectUIMessage *message;
@property (readonly, copy, nonatomic) NSString *text;
@property (readonly, nonatomic) IGDirectLinkContext *linkContext;
...
/* instance methods */
- (id)initWithMessage:(id)message text:(id)text linkContext:(id)context;
