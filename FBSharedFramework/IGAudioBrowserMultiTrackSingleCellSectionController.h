...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGAudioBrowserMultiTrackSingleCellSectionController_h
#define IGAudioBrowserMultiTrackSingleCellSectionController_h
@import Foundation;
...
@class NSString;
@protocol IGAudioBrowserMultiTrackSingleCellSectionControllerDelegate;

@interface IGAudioBrowserMultiTrackSingleCellSectionController : IGListBindingSectionController<IGListBindingSectionControllerDataSource, IGListBindingSectionControllerSelectionDelegate>

@property (weak, nonatomic) NSObject<IGAudioBrowserMultiTrackSingleCellSectionControllerDelegate> *delegate;
...
#endif /* IGAudioBrowserMultiTrackSingleCellSectionController_h */
