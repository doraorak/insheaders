...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGAudioRecordWaveformView_h
#define IGAudioRecordWaveformView_h
@import Foundation;
...
@interface IGAudioRecordWaveformView : UIView<UICollectionViewDataSource, UICollectionViewDelegateFlowLayout> {
  /* instance variables */
...
- (void)layoutSubviews;
- (void)addIntervalValue:(double)value;
...
#endif /* IGAudioRecordWaveformView_h */
