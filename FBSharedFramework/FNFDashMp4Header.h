...
//    - LC_SOURCE_VERSION: 
//
#ifndef FNFDashMp4Header_h
#define FNFDashMp4Header_h
@import Foundation;

#include "FNFDashFetchRange.h"
#include "FNFDashMp4StreamReader.h"

@class NSData, NSDictionary, NSError, NSMutableData, NSString;
@protocol {FNFMP4MoovAtom="mvhdAtom"{FNFMP4MvhdAtom="timescale"I"duration"I"rotationAngle"f}"trakAtoms"{vector<FNFMP4TrakAtom, std::allocator<FNFMP4TrakAtom>>="__begin_"^{FNFMP4TrakAtom}"__end_"^{FNFMP4TrakAtom}"__end_cap_"{__compressed_pair<FNFMP4TrakAtom *, std::allocator<FNFMP4TrakAtom>>="__value_"^{FNFMP4TrakAtom}}}"mvexAtom"{FNFMP4MvexAtom="mehdAtom"{FNFMP4MehdAtom="duration"i}"trexAtoms"{vector<FNFMP4TrexAtom, std::allocator<FNFMP4TrexAtom>>="__begin_"^{FNFMP4TrexAtom}"__end_"^{FNFMP4TrexAtom}"__end_cap_"{__compressed_pair<FNFMP4TrexAtom *, std::allocator<FNFMP4TrexAtom>>="__value_"^{FNFMP4TrexAtom}}}}}, {FNFMP4SidxAtom="timescale"I"segments"{vector<FNFMP4SidxSegment, std::allocator<FNFMP4SidxSegment>>="__begin_"^{FNFMP4SidxSegment}"__end_"^{FNFMP4SidxSegment}"__end_cap_"{__compressed_pair<FNFMP4SidxSegment *, std::allocator<FNFMP4SidxSegment>>="__value_"^{FNFMP4SidxSegment}}}}, {vector<unsigned long long, std::allocator<unsigned long long>>="__begin_"^Q"__end_"^Q"__end_cap_"{__compressed_pair<unsigned long long *, std::allocator<unsigned long long>>="__value_"^Q}};

@interface FNFDashMp4Header : NSObject {
  /* instance variables */
  unsigned long long _fetchState;
  NSMutableData *_fetchBuffer;
  FNFDashMp4StreamReader *_streamReader;
  NSData *_encodedInitSegment;
  struct FNFMP4SidxAtom { unsigned int timescale; struct vector<FNFMP4SidxSegment, std::allocator<FNFMP4SidxSegment>> { struct FNFMP4SidxSegment *__begin_; struct FNFMP4SidxSegment *__end_; struct __compressed_pair<FNFMP4SidxSegment *, std::allocator<FNFMP4SidxSegment>> { struct FNFMP4SidxSegment *__value_; } __end_cap_; } segments; } _sidxAtom;
  BOOL _sidxAtomParsed;
  BOOL _enableDashMp4RotationSupport;
  ...
  BOOL _disableFormatChanges;
  struct vector<unsigned long long, std::allocator<unsigned long long>> { unsigned long long *__begin_; unsigned long long *__end_; struct __compressed_pair<unsigned long long *, std::allocator<unsigned long long>> { unsigned long long *__value_; } __end_cap_; } _editListPreProcessedSegmentDuration;
}
