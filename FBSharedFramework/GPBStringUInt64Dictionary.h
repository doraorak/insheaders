...
/* instance methods */
- (id)init;
- (id)initWithUInt64s:(const unsigned long long *)uint64s forKeys:(id *)keys count:(unsigned long long)count;
...
- (void)removeUInt64ForKey:(id)key;
- (void)removeAll;
@end

#endif /* GPBStringUInt64Dictionary_h */
