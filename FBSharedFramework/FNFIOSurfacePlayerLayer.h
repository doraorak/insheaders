...
@class NSString;
@protocol FNFDisplayFilter, FNFPlayerDisplayLayerDelegate;

@interface FNFIOSurfacePlayerLayer : CALayer<FNFPlayerDisplayLayer> {
  /* instance variables */
  ...
  struct __CVBuffer * _layerPixelBuffer;
  NSObject<FNFDisplayFilter> *_upscaleFilter;
}
...
#endif /* FNFIOSurfacePlayerLayer_h */
