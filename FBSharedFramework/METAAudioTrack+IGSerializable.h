...
//    - LC_SOURCE_VERSION: 
//
#ifndef METAAudioTrack_IGSerializable_h
#define METAAudioTrack_IGSerializable_h
@import Foundation;

@interface METAAudioTrack (IGSerializable) <IGSerializable>
/* class methods */
...
#endif /* METAAudioTrack_IGSerializable_h */
