...
//    - LC_SOURCE_VERSION: 
//
#ifndef FXRemoveRequest_h
#define FXRemoveRequest_h
@import Foundation;
...
@interface FXRemoveRequest : NSObject<FXRequestDebuggable, FXRequestProtocol>
...
- (id)initWithQuery:(id)query logLocation:(id)location;
@end

#endif /* FXRemoveRequest_h */
