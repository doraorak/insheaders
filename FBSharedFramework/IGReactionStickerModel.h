...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGReactionStickerModel_h
#define IGReactionStickerModel_h
@import Foundation;
...
@interface IGReactionStickerModel : NSObject<IGListDiffable, IGStickerModelType, IGSmartStickerModelType, NSCoding>
...
#endif /* IGReactionStickerModel_h */
