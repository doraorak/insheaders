...
//    - LC_SOURCE_VERSION: 
//
#ifndef UIImage_IGStoryMediaAsset_h
#define UIImage_IGStoryMediaAsset_h
@import Foundation;
...
- (void)fetchVideoWithUserSession:(id /* block */)session resultHandler:(id)handler;
...
#endif /* UIImage_IGStoryMediaAsset_h */
