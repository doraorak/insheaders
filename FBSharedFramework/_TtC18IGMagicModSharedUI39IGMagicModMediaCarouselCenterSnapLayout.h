...
//    - LC_SOURCE_VERSION: 
//
#ifndef _TtC18IGMagicModSharedUI39IGMagicModMediaCarouselCenterSnapLayout_h
#define _TtC18IGMagicModSharedUI39IGMagicModMediaCarouselCenterSnapLayout_h
@import Foundation;

#include "UICollectionViewFlowLayout.h"

@interface _TtC18IGMagicModSharedUI39IGMagicModMediaCarouselCenterSnapLayout : UICollectionViewFlowLayout { // (Swift)
  /* instance variables */
   calculatedLayoutAttributes;
...
#endif /* _TtC18IGMagicModSharedUI39IGMagicModMediaCarouselCenterSnapLayout_h */
