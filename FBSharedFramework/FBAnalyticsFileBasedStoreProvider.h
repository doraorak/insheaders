...
//    - LC_SOURCE_VERSION: 
//
#ifndef FBAnalyticsFileBasedStoreProvider_h
#define FBAnalyticsFileBasedStoreProvider_h
@import Foundation;
...
- (void)removeAnalyticsEventsWithMaxEventCount:(unsigned long long)count;
- (id)fetchAllAnalyticsEvents;
- (void)closeAnalyticsEventStore;
- (void)removeEventsFromLastFetch;
- (void)_broadcastFileCountInformation;
@end

#endif /* FBAnalyticsFileBasedStoreProvider_h */
