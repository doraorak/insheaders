...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGStoryPhotoLibraryAsset_h
#define IGStoryPhotoLibraryAsset_h
@import Foundation;
...
@interface IGStoryPhotoLibraryAsset : NSObject<METAMediaAsset, IGStoryMediaAsset> {
  /* instance variables */
...
@property (readonly, nonatomic) IGMetaGalleryAttributionMetadata *metaGalleryAttributionMetadata;
...
/* instance methods */
- (id)initWithPhotoLibraryAsset:(id)asset previewImage:(id)image videoDuration:(double)duration attribution:(id)attribution metaGalleryAttributionMetadata:(id)metadata userSession:(id)session;
- (id)renderer;
...
#endif /* IGStoryPhotoLibraryAsset_h */
