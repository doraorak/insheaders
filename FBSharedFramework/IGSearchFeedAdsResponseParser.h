...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGSearchFeedAdsResponseParser_h
#define IGSearchFeedAdsResponseParser_h
@import Foundation;
...
@interface IGSearchFeedAdsResponseParser : NSObject<IGNetworkParser> {
  /* instance variables */
...
#endif /* IGSearchFeedAdsResponseParser_h */
