...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGIntentAwareSundialAdsResponseParser_h
#define IGIntentAwareSundialAdsResponseParser_h
@import Foundation;
...
@interface IGIntentAwareSundialAdsResponseParser : NSObject<IGNetworkParser> {
  /* instance variables */
...
#endif /* IGIntentAwareSundialAdsResponseParser_h */
