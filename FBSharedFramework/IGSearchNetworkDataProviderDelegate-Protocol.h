...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGSearchNetworkDataProviderDelegate_Protocol_h
#define IGSearchNetworkDataProviderDelegate_Protocol_h
@import Foundation;
...
#endif /* IGSearchNetworkDataProviderDelegate_Protocol_h */
