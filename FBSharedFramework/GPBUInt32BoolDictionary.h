...
//    - LC_SOURCE_VERSION: 
//
#ifndef GPBUInt32BoolDictionary_h
#define GPBUInt32BoolDictionary_h
@import Foundation;
...
/* instance methods */
- (id)init;
- (id)initWithBools:(const BOOL *)bools forKeys:(const unsigned int *)keys count:(unsigned long long)count;
...
#endif /* GPBUInt32BoolDictionary_h */
