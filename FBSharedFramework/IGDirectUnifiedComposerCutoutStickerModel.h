...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGDirectUnifiedComposerCutoutStickerModel_h
#define IGDirectUnifiedComposerCutoutStickerModel_h
@import Foundation;
...
@interface IGDirectUnifiedComposerCutoutStickerModel : NSObject<IGListDiffable, IGStickerModelType, IGSmartStickerModelType, NSSecureCoding>
...
#endif /* IGDirectUnifiedComposerCutoutStickerModel_h */
