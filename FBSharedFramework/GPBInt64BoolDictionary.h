...
//    - LC_SOURCE_VERSION: 
//
#ifndef GPBInt64BoolDictionary_h
#define GPBInt64BoolDictionary_h
@import Foundation;
...
/* instance methods */
- (id)init;
- (id)initWithBools:(const BOOL *)bools forKeys:(const long long *)keys count:(unsigned long long)count;
...
- (BOOL)getBool:(BOOL *)bool forKey:(long long)key;
- (void)addEntriesFromDictionary:(id)dictionary;
- (void)setBool:(BOOL)bool forKey:(long long)key;
- (void)removeBoolForKey:(long long)key;
- (void)removeAll;
@end

#endif /* GPBInt64BoolDictionary_h */
