...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGFNFStitchQualityManager_h
#define IGFNFStitchQualityManager_h
@import Foundation;

#include "FNFDashQualitySelectorCreating-Protocol.h"
#include "FNFStitchQualityManager.h"
#include "IGFNFDashQualityManager.h"
...
/* instance methods */
- (id)initWithStitchContextProvider:(id)provider launcherSetProvider:(id)provider isLive:(BOOL)live isPrefetch:(BOOL)prefetch;
...
#endif /* IGFNFStitchQualityManager_h */
