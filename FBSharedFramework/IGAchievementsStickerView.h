...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGAchievementsStickerView_h
#define IGAchievementsStickerView_h
@import Foundation;
...
@interface IGAchievementsStickerView : UIView<IGStickerViewType, IGSerializable, IGStoryStickerDeletable, IGConstrainedSizeStickerViewType> {
  /* instance variables */
...
/* instance methods */
- (id)initWithAchievementImageURL:(id)url achievementId:(id)id;
- (void)layoutSubviews;
...
#endif /* IGAchievementsStickerView_h */
