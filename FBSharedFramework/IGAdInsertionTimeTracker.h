...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGAdInsertionTimeTracker_h
#define IGAdInsertionTimeTracker_h
@import Foundation;

#include "NSObject-Protocol.h"

@class NSCache, NSString;
@protocol IGAdInsertionMediaTrackerDelegate, IGAdPlatformStatesSnapshot;

@interface IGAdInsertionTimeTracker : NSObject<NSObject> {
  /* instance variables */
  ...
  double _offsetTimer;
  NSObject<IGAdPlatformStatesSnapshot> *_statesSnapshot;
}
...
#endif /* IGAdInsertionTimeTracker_h */
