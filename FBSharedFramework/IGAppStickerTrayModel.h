...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGAppStickerTrayModel_h
#define IGAppStickerTrayModel_h
@import Foundation;
...
@interface IGAppStickerTrayModel : NSObject<IGListDiffable, IGStickerModelType, IGSmartStickerModelType, NSCoding>
