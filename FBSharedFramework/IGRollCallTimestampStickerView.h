...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGRollCallTimestampStickerView_h
#define IGRollCallTimestampStickerView_h
@import Foundation;
...
@interface IGRollCallTimestampStickerView : UIView<IGStickerViewType, IGStoryStickerDeletable, IGConstrainedSizeStickerViewType> {
  /* instance variables */
...
/* instance methods */
- (id)initWithDate:(id)date style:(long long)style;
- (void)layoutSubviews;
...
#endif /* IGRollCallTimestampStickerView_h */
