...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGContextualFeedContext_IGPlaybackCoordinator_h
#define IGContextualFeedContext_IGPlaybackCoordinator_h
@import Foundation;
...
@interface IGContextualFeedContext (IGPlaybackCoordinator)
/* instance methods */
- (id)playbackCoordinator;
@end

#endif /* IGContextualFeedContext_IGPlaybackCoordinator_h */
