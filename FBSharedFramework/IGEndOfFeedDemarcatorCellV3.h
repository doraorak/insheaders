...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGEndOfFeedDemarcatorCellV3_h
#define IGEndOfFeedDemarcatorCellV3_h
@import Foundation;
...
@interface IGEndOfFeedDemarcatorCellV3 : UICollectionViewCell<NSObject> {
  /* instance variables */
...
#endif /* IGEndOfFeedDemarcatorCellV3_h */
