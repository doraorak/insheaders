...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGDirectUnifiedComposerImagineCreateModel_h
#define IGDirectUnifiedComposerImagineCreateModel_h
@import Foundation;
...
@interface IGDirectUnifiedComposerImagineCreateModel : NSObject<IGListDiffable, IGStickerModelType, IGSmartStickerModelType, NSSecureCoding>
...
#endif /* IGDirectUnifiedComposerImagineCreateModel_h */
