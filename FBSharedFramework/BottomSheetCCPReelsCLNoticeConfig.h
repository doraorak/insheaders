...
//    - LC_SOURCE_VERSION: 
//
#ifndef BottomSheetCCPReelsCLNoticeConfig_h
#define BottomSheetCCPReelsCLNoticeConfig_h
@import Foundation;
...
@interface BottomSheetCCPReelsCLNoticeConfig : NSObject<CLNoticeConfig> {
  /* instance variables */
  NSObject<IGUserLauncherSetProviding> *_provider;
}
...
#endif /* BottomSheetCCPReelsCLNoticeConfig_h */
