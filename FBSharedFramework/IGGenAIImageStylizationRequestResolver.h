...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGGenAIImageStylizationRequestResolver_h
#define IGGenAIImageStylizationRequestResolver_h
@import Foundation;
...
#include "IGGenAIImageStylizationRequest.h"
#include "IGUserSession.h"

@class NSString;

@interface IGGenAIImageStylizationRequestResolver : NSObject<IGGenAIImageRequestResolver> {
  /* instance variables */
  IGUserSession *_session;
  IGGenAIImageStylizationRequest *_request;
...
#endif /* IGGenAIImageStylizationRequestResolver_h */
