...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGAudioMusicTrack_h
#define IGAudioMusicTrack_h
@import Foundation;
...
@interface IGAudioMusicTrack : NSObject<NSCopying, NSSecureCoding, IGListDiffable, IGAudioModelProtocol, IGAudioEffectRenderingProtocol> {
  /* instance variables */
...
@property (readonly, nonatomic) IGAsyncTask *beats;
@property (readonly, nonatomic) NSData *highlightStartTimeDashManifestData_USE_WITH_CAUTION;
...
/* class methods */
+ (id)newWithTrackDict:(id)dict metadataDict:(id)dict;
+ (BOOL)supportsSecureCoding;

/* instance methods */
- (id)initWithPk:(id)pk audioClusterId:(id)id title:(id)title artistName:(id)name albumArtURL:(id)url albumArtThumbnailURL:(id)url audioFileURL:(id)url highlightTimeInMilliseconds:(id)milliseconds durationInMilliseconds:(long long)milliseconds isExplicit:(BOOL)explicit hasLyrics:(BOOL)lyrics;
- (id)initWithPk:(id)pk audioClusterId:(id)id title:(id)title artistName:(id)name albumArtURL:(id)url albumArtThumbnailURL:(id)url audioAsset:(id)asset highlightTimeInMilliseconds:(id)milliseconds durationInMilliseconds:(long long)milliseconds isExplicit:(BOOL)explicit hasLyrics:(BOOL)lyrics darkMessage:(id)message allowsSaving:(BOOL)saving isBookmarked:(BOOL)bookmarked isTrending:(BOOL)trending trendingRankNumber:(id)number shouldAllowMediaCreationWithMusic:(BOOL)music formattedClipsMediaCount:(id)count playableReelId:(id)id dashManifestData:(id)data isEligibleForAudioEffects:(BOOL)effects audioEffects:(id)effects;
- (id)initWithPk:(id)pk audioClusterId:(id)id title:(id)title artistName:(id)name albumArtURL:(id)url albumArtThumbnailURL:(id)url audioFileURL:(id)url highlightTimeInMilliseconds:(id)milliseconds durationInMilliseconds:(long long)milliseconds isExplicit:(BOOL)explicit hasLyrics:(BOOL)lyrics darkMessage:(id)message allowsSaving:(BOOL)saving isBookmarked:(BOOL)bookmarked isTrending:(BOOL)trending trendingRankNumber:(id)number shouldAllowMediaCreationWithMusic:(BOOL)music formattedClipsMediaCount:(id)count playableReelId:(id)id dashManifestData:(id)data highlightStartTimeDashManifestData:(id)data isEligibleForAudioEffects:(BOOL)effects audioEffects:(id)effects;
