...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGFBVideoProcessingWrapper_h
#define IGFBVideoProcessingWrapper_h
@import Foundation;
...
@interface IGFBVideoProcessingWrapper : NSObject<NSObject> {
  /* instance variables */
...
/* instance methods */
- (id)initWithVideoProcessor:(id)processor;
...
#endif /* IGFBVideoProcessingWrapper_h */
