...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGStoryCameraSampleBufferCaptureResult_h
#define IGStoryCameraSampleBufferCaptureResult_h
@import Foundation;

#include "IGAsyncTask.h"
#include "IGCameraSampleBuffer.h"
...
@interface IGStoryCameraSampleBufferCaptureResult : NSObject<METAMediaAsset, IGStoryMediaAsset> {
  /* instance variables */
  IGUserSession *_userSession;
  IGCameraSampleBuffer *_previewSampleBuffer;
}

@property (readonly, nonatomic) IGAsyncTask *sampleBufferCreationTask;
...
@property (readonly, nonatomic) NSDictionary *imageMetadata;
...
/* instance methods */
- (id)initWithSampleBufferCreationTask:(id)task imageSize:(struct CGSize { double x0; double x1; })size previewSampleBuffer:(id)buffer userSession:(id)session;
- (id)initWithSampleBufferCreationTask:(id)task imageSize:(struct CGSize { double x0; double x1; })size previewSampleBuffer:(id)buffer;
...
#endif /* IGStoryCameraSampleBufferCaptureResult_h */
