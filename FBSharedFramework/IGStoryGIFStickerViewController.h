...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGStoryGIFStickerViewController_h
#define IGStoryGIFStickerViewController_h
@import Foundation;
...
@protocol IGGiphyFetching, IGStoryGIFStickerViewControllerDelegate;

@interface IGStoryGIFStickerViewController : IGViewController<IGSearchBarDelegate, IGKeyboardObserverFrameChangeDelegate, IGStickerViewControllerSelectionDelegate, IGGestureHandler> {
  /* instance variables */
  NSObject<IGGiphyFetching> *_giphyDataSource;
  NSObject<FBCancelable> *_trendingRequestToken;
  NSObject<FBCancelable> *_activeSearchRequestToken;
  ...
  BOOL _showKeyboardOnAppearance;
  IGStickerViewController *_resultsViewController;
}

@property (weak, nonatomic) NSObject<IGStoryGIFStickerViewControllerDelegate> *delegate;
...
/* instance methods */
- (id)initWithUserSession:(id)session initialSearchQuery:(id)query requestSurface:(unsigned long long)surface searchUserFlowLogger:(id)logger storyStickerDataSourceType:(unsigned long long)type;
...
#endif /* IGStoryGIFStickerViewController_h */
