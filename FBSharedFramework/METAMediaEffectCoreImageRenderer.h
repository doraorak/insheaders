...
//    - LC_SOURCE_VERSION: 
//
#ifndef METAMediaEffectCoreImageRenderer_h
#define METAMediaEffectCoreImageRenderer_h
@import Foundation;
...
@interface METAMediaEffectCoreImageRenderer : NSObject<NSObject> {
  /* instance variables */
...
#endif /* METAMediaEffectCoreImageRenderer_h */
