...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGBouncyCollectionViewCell_h
#define IGBouncyCollectionViewCell_h
@import Foundation;
...
@interface IGBouncyCollectionViewCell : UICollectionViewCell<NSObject> {
  /* instance variables */
...
#endif /* IGBouncyCollectionViewCell_h */
