...
//    - LC_SOURCE_VERSION: 
//
#ifndef UIView_FBViewpointTrackableExtended_h
#define UIView_FBViewpointTrackableExtended_h
@import Foundation;
...
- (void)setVp_level:(long long)vp_level;
@end

#endif /* UIView_FBViewpointTrackableExtended_h */
