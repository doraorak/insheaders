...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGSwitchViewProvider_h
#define IGSwitchViewProvider_h
@import Foundation;

#include "IGDSSwitch.h"
#include "IGSettingsDescriptionBodyView.h"
#include "IGSwitchViewModel.h"
...
@interface IGSwitchViewProvider : NSObject<NSObject> {
  /* instance variables */
...
@property (weak, nonatomic) NSObject<IGSwitchViewProviderDelegate> *delegate;
@property (readonly, nonatomic) IGSwitchViewModel *viewModel;
