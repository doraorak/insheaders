...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGRealtimeOctaneEventForwarder_h
#define IGRealtimeOctaneEventForwarder_h
@import Foundation;
...
@interface IGRealtimeOctaneEventForwarder : NSObject<IGRealtimeServerPayloadHandler> {
  /* instance variables */
...
#endif /* IGRealtimeOctaneEventForwarder_h */
