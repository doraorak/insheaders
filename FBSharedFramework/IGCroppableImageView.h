...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGCroppableImageView_h
#define IGCroppableImageView_h
@import Foundation;
...
@property (nonatomic) struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; } scaledCropRect;
