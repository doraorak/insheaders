...
//    - LC_SOURCE_VERSION: 
//
#ifndef GPBInt32FloatDictionary_h
#define GPBInt32FloatDictionary_h
@import Foundation;
...
/* instance methods */
- (id)init;
- (id)initWithFloats:(const float *)floats forKeys:(const int *)keys count:(unsigned long long)count;
...
#endif /* GPBInt32FloatDictionary_h */
