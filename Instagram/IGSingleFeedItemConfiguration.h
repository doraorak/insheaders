...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGSingleFeedItemConfiguration_h
#define IGSingleFeedItemConfiguration_h
@import Foundation;
...
@interface IGSingleFeedItemConfiguration : NSObject<IGFeedItemConfigurationType> {
  ...
  BOOL _isFeedItemFromPromotionNotification;
  BOOL _isFeedItemFromBCAdApprovalNotification;
  BOOL _isProfileEntryPoint;
  BOOL _hideSponsoredContext;
  BOOL _showThumbnailOnHeader;
  BOOL _shouldDisableToolsIfUnownedParentMedia;
  NSString *_carouselMediaId;
  NSString *_overridenCarouselPostItemPk;
  NSString *_collabInviteResponse;
...
@property (weak, nonatomic) NSObject<IGFollowControllerLoggingProvider> *followButtonLoggingProvider;
...
/* instance methods */
- (id)initWithUserSession:(id)session ctaPresenterContext:(id)context;
...
#endif /* IGSingleFeedItemConfiguration_h */
