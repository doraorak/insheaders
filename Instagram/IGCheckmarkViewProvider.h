...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGCheckmarkViewProvider_h
#define IGCheckmarkViewProvider_h
@import Foundation;
...
@interface IGCheckmarkViewProvider : NSObject<NSObject> {
  /* instance variables */
  long long _trailingViewAlignment;
...
- (id)initWithLayoutSpec:(id)spec trailingViewAlignment:(long long)alignment;
...
#endif /* IGCheckmarkViewProvider_h */
