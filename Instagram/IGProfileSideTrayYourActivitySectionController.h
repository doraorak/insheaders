...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGProfileSideTrayYourActivitySectionController_h
#define IGProfileSideTrayYourActivitySectionController_h
@import Foundation;
...
@interface IGProfileSideTrayYourActivitySectionController : IGListSectionController<IGSideTrayItemSectionController> {
  /* instance variables */
...
#endif /* IGProfileSideTrayYourActivitySectionController_h */
