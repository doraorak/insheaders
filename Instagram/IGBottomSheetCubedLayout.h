...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGBottomSheetCubedLayout_h
#define IGBottomSheetCubedLayout_h
@import Foundation;

#include "UICollectionViewFlowLayout.h"

@interface IGBottomSheetCubedLayout : UICollectionViewFlowLayout
/* instance methods */
- (id)init;
...
#endif /* IGBottomSheetCubedLayout_h */
