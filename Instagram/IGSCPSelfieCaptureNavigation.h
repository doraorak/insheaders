...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGSCPSelfieCaptureNavigation_h
#define IGSCPSelfieCaptureNavigation_h
@import Foundation;
...
@interface IGSCPSelfieCaptureNavigation : NSObject<NSObject> {
  /* instance variables */
...
@property (weak, nonatomic) NSObject<IGSCPSelfieCaptureNavigationDelegate> *navigationDelegate;
...
#endif /* IGSCPSelfieCaptureNavigation_h */
