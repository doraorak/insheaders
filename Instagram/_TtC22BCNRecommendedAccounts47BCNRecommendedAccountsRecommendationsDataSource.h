...
//    - LC_SOURCE_VERSION: 
//
#ifndef _TtC22BCNRecommendedAccounts47BCNRecommendedAccountsRecommendationsDataSource_h
#define _TtC22BCNRecommendedAccounts47BCNRecommendedAccountsRecommendationsDataSource_h
@import Foundation;

#include "IGNetworkSourceDelegate-Protocol.h"

@interface _TtC22BCNRecommendedAccounts47BCNRecommendedAccountsRecommendationsDataSource : NSObject<IGNetworkSourceDelegate> { // (Swift)
  /* instance variables */
   delegate;
   isLoading;
   isMoreAvailable;
...
#endif /* _TtC22BCNRecommendedAccounts47BCNRecommendedAccountsRecommendationsDataSource_h */
