...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGUnifiedVideoControlsViewDelegate_Protocol_h
#define IGUnifiedVideoControlsViewDelegate_Protocol_h
@import Foundation;
...
#endif /* IGUnifiedVideoControlsViewDelegate_Protocol_h */
