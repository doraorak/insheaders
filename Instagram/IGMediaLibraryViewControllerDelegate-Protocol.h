...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGMediaLibraryViewControllerDelegate_Protocol_h
#define IGMediaLibraryViewControllerDelegate_Protocol_h
@import Foundation;
...
#endif /* IGMediaLibraryViewControllerDelegate_Protocol_h */
