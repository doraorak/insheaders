...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGFeedItemUFICellConfigurableDelegate_Protocol_h
#define IGFeedItemUFICellConfigurableDelegate_Protocol_h
@import Foundation;
...
#endif /* IGFeedItemUFICellConfigurableDelegate_Protocol_h */
