...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGDirectSubscriberMessagingTokenFieldController_h
#define IGDirectSubscriberMessagingTokenFieldController_h
@import Foundation;

#include "IGTokenFieldDelegate-Protocol.h"

@class IGTokenField, NSString;
@protocol IGDirectSubscriberMessagingTokenFieldControllerDelegate;

@interface IGDirectSubscriberMessagingTokenFieldController : NSObject<IGTokenFieldDelegate> {
  /* instance variables */
...
@property (weak, nonatomic) NSObject<IGDirectSubscriberMessagingTokenFieldControllerDelegate> *delegate;
...
/* instance methods */
- (id)initWithTokenFieldTheme:(id)theme;
...
#endif /* IGDirectSubscriberMessagingTokenFieldController_h */
