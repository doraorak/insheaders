...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGVideoCallStartIntentTarget_h
#define IGVideoCallStartIntentTarget_h
@import Foundation;

#include "FBIntentTarget-Protocol.h"

@class FBWeakObjectContainer, NSArray, NSDictionary, NSString;
...
/* instance methods */
- (id)initWithTrigger:(long long)trigger type:(long long)type threadId:(id)id threadDisplayName:(id)name threadUsers:(id)users openThreadId:(id)id armadilloThreadId:(id)id occamadilloThreadId:(id)id xmaType:(long long)type isShhMode:(BOOL)mode isE2eeMandated:(BOOL)mandated isCutoverThread:(BOOL)thread productParams:(id)params callFunnelClient:(id)client;
@end

#endif /* IGVideoCallStartIntentTarget_h */
