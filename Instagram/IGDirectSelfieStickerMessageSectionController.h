...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGDirectSelfieStickerMessageSectionController_h
#define IGDirectSelfieStickerMessageSectionController_h
@import Foundation;
...
#endif /* IGDirectSelfieStickerMessageSectionController_h */
