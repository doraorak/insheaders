...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGLiveE2ENetworkInfoProvider_h
#define IGLiveE2ENetworkInfoProvider_h
@import Foundation;
...
@interface IGLiveE2ENetworkInfoProvider : NSObject<NSObject>
...
#endif /* IGLiveE2ENetworkInfoProvider_h */
