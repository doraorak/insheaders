...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGDiscoveryContainerCarouselSectionController_h
#define IGDiscoveryContainerCarouselSectionController_h
@import Foundation;
...
@interface IGDiscoveryContainerCarouselSectionController : IGListSectionController<IGListAdapterDataSource, UIScrollViewDelegate> {
  /* instance variables */
...
#endif /* IGDiscoveryContainerCarouselSectionController_h */
