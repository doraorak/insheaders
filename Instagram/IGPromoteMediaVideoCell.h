...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGPromoteMediaVideoCell_h
#define IGPromoteMediaVideoCell_h
@import Foundation;
...
@interface IGPromoteMediaVideoCell : UICollectionViewCell<IGVideoViewListener, IGVideoPlayerOverlayAdapterDelegate, IGVideoPlayerOverlayControllerDelegate> {
  /* instance variables */
...
#endif /* IGPromoteMediaVideoCell_h */
