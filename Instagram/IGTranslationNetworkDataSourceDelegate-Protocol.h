...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGTranslationNetworkDataSourceDelegate_Protocol_h
#define IGTranslationNetworkDataSourceDelegate_Protocol_h
@import Foundation;
...
#endif /* IGTranslationNetworkDataSourceDelegate_Protocol_h */
