...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGDirectOnDeviceNudityThreadMegaphonePresenter_h
#define IGDirectOnDeviceNudityThreadMegaphonePresenter_h
@import Foundation;

#include "IGDirectOnDeviceNudityThreadMegaphoneView.h"
#include "IGQPMegaphoneViewDelegate-Protocol.h"

@class IGQPMegaphone, NSString;
@protocol IGQPViewPresenterDelegate;

@interface IGDirectOnDeviceNudityThreadMegaphonePresenter : NSObject<IGQPMegaphoneViewDelegate> {
  /* instance variables */
  IGDirectOnDeviceNudityThreadMegaphoneView *_megaphoneView;
...
#endif /* IGDirectOnDeviceNudityThreadMegaphonePresenter_h */
