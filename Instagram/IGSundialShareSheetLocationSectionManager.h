...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGSundialShareSheetLocationSectionManager_h
#define IGSundialShareSheetLocationSectionManager_h
@import Foundation;

#include "_TtP26IGSundialShareSheetContext34IGSundialShareSheetSectionManaging_-Protocol.h"

@interface IGSundialShareSheetLocationSectionManager : NSObject<_TtP26IGSundialShareSheetContext34IGSundialShareSheetSectionManaging_> { // (Swift)
  /* instance variables */
   locationManager;
   context;
}
...
#endif /* IGSundialShareSheetLocationSectionManager_h */
