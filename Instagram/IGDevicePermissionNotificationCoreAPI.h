...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGDevicePermissionNotificationCoreAPI_h
#define IGDevicePermissionNotificationCoreAPI_h
@import Foundation;
...
@interface IGDevicePermissionNotificationCoreAPI : DevicePermissionCoreAPI<NSObject> {
  /* instance variables */
...
#endif /* IGDevicePermissionNotificationCoreAPI_h */
