...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGShoppingSearchProductListActionViewProvider_h
#define IGShoppingSearchProductListActionViewProvider_h
@import Foundation;
...
@interface IGShoppingSearchProductListActionViewProvider : NSObject<NSObject> {
  /* instance variables */
...
#endif /* IGShoppingSearchProductListActionViewProvider_h */
