...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGUserListGroupViewProvider_h
#define IGUserListGroupViewProvider_h
@import Foundation;

#include "NSObject-Protocol.h"

@class IGDirectAvatarView, IGProfileCellBodyView, IGTableLayoutSpec, NSString, UIImageView;
@protocol IGListItemViewProviderDelegate;

@interface IGUserListGroupViewProvider : NSObject<NSObject> {
  /* instance variables */
  BOOL _shouldUseCustomIcon;
...
- (id)initWithLayoutSpec:(id)spec shouldUseCustomIcon:(BOOL)icon;
...
#endif /* IGUserListGroupViewProvider_h */
