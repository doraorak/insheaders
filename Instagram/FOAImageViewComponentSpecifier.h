...
//    - LC_SOURCE_VERSION: 
//
#ifndef FOAImageViewComponentSpecifier_h
#define FOAImageViewComponentSpecifier_h
@import Foundation;

#include "NSObject-Protocol.h"

@class FBImageRenderState, NSArray, NSObject, NSString;
...
@interface FOAImageViewComponentSpecifier : NSObject<NSObject> {
  /* instance variables */
  NSObject<FBWebImageSpecifier> *_lightModeSpecifier;
  NSObject<FBWebImageSpecifier> *_darkModeSpecifier;
...
/* instance methods */
- (id)initWithLightModeSpecifier:(id)specifier darkModeSpecifier:(id)specifier imageListeners:(id)listeners imagePerfLogger:(id)logger imageRenderState:(id)state appModel:(id)model options:(struct MRCImageViewOptions { long long x0; BOOL x1; BOOL x2; BOOL x3; id x4; struct MRCProgressRingOptions { struct MRCProgressRingDiameter { unsigned long long x0; double x1; } x0; double x1; id x2; } x5; struct MRCImagePlaceholderOptions { id x0; id x1; id x2; long long x3; } x6; id x7; id x8; id x9; id x10; unsigned long long x11; BOOL x12; BOOL x13; BOOL x14; })options;
...
#endif /* FOAImageViewComponentSpecifier_h */
