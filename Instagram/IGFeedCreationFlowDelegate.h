...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGFeedCreationFlowDelegate_h
#define IGFeedCreationFlowDelegate_h
@import Foundation;
...
@interface IGFeedCreationFlowDelegate : NSObject<IGFeedCreationFlowDelegate> {
  /* instance variables */
  IGCameraNavigationController *_navigationController;
...
#endif /* IGFeedCreationFlowDelegate_h */
