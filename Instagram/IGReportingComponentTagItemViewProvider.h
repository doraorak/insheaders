...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGReportingComponentTagItemViewProvider_h
#define IGReportingComponentTagItemViewProvider_h
@import Foundation;
...
@interface IGReportingComponentTagItemViewProvider : NSObject<NSObject> {
  /* instance variables */
  UILabel *_bodyLabel;
...
#endif /* IGReportingComponentTagItemViewProvider_h */
