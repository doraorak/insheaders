...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGRegistrationPasswordStepController_h
#define IGRegistrationPasswordStepController_h
@import Foundation;

#include "IGRegistrationSignUpViewController.h"
#include "NSObject-Protocol.h"

@class IGRegistrationFlowContext, NSString;
@protocol IGRegistrationCoordinatorProtocol;

@interface IGRegistrationPasswordStepController : NSObject<NSObject> {
  /* instance variables */
...
#endif /* IGRegistrationPasswordStepController_h */
