...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGQPAudioBrowserCondensedMegaphonePresenter_h
#define IGQPAudioBrowserCondensedMegaphonePresenter_h
@import Foundation;

#include "IGQPAudioBrowserCondensedMegaphoneView.h"
#include "IGQPMegaphoneViewDelegate-Protocol.h"

@class IGQPMegaphone, NSString;
@protocol IGQPViewPresenterDelegate;

@interface IGQPAudioBrowserCondensedMegaphonePresenter : NSObject<IGQPMegaphoneViewDelegate> {
  /* instance variables */
  IGQPMegaphone *_megaphone;
  IGQPAudioBrowserCondensedMegaphoneView *_megaphoneView;
}
...
#endif /* IGQPAudioBrowserCondensedMegaphonePresenter_h */
