...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGPhotoEditorViewController_IGTextProvider_h
#define IGPhotoEditorViewController_IGTextProvider_h
@import Foundation;

@interface IGPhotoEditorViewController (IGTextProvider) <IGStoryTextEntryViewControllerDelegate>
/* instance methods */
...
#endif /* IGPhotoEditorViewController_IGTextProvider_h */
