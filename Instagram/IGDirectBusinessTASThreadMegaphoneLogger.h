...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGDirectBusinessTASThreadMegaphoneLogger_h
#define IGDirectBusinessTASThreadMegaphoneLogger_h
@import Foundation;

#include "IGAnalyticsEventLoggingProtocol-Protocol.h"
#include "IGDirectBusinessTASThreadMegaphoneDataProvider.h"
#include "IGGenericMegaphoneLogger-Protocol.h"

@class NSString;

@interface IGDirectBusinessTASThreadMegaphoneLogger : NSObject<IGGenericMegaphoneLogger> {
  /* instance variables */
  IGDirectBusinessTASThreadMegaphoneDataProvider *_dataProvider;
...
#endif /* IGDirectBusinessTASThreadMegaphoneLogger_h */
