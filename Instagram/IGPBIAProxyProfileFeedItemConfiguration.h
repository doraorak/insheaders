...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGPBIAProxyProfileFeedItemConfiguration_h
#define IGPBIAProxyProfileFeedItemConfiguration_h
@import Foundation;
...
/* instance methods */
- (id)initWithUserSession:(id)session shouldShowUFI:(BOOL)ufi;
...
#endif /* IGPBIAProxyProfileFeedItemConfiguration_h */
