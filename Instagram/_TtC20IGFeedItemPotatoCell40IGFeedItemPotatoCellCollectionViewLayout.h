...
//    - LC_SOURCE_VERSION: 
//
#ifndef _TtC20IGFeedItemPotatoCell40IGFeedItemPotatoCellCollectionViewLayout_h
#define _TtC20IGFeedItemPotatoCell40IGFeedItemPotatoCellCollectionViewLayout_h
@import Foundation;

#include "UICollectionViewLayout.h"

@interface _TtC20IGFeedItemPotatoCell40IGFeedItemPotatoCellCollectionViewLayout : UICollectionViewLayout { // (Swift)
  /* instance variables */
   dataSource;
   layoutAttributes;
}
...
#endif /* _TtC20IGFeedItemPotatoCell40IGFeedItemPotatoCellCollectionViewLayout_h */
