...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGFeedItemTextCellDataSourceImpl_h
#define IGFeedItemTextCellDataSourceImpl_h
@import Foundation;
...
@interface IGFeedItemTextCellDataSourceImpl : NSObject<IGFeedItemTextCellDataSourceProtocol> {
  /* instance variables */
  IGMedia *_media;
...
#endif /* IGFeedItemTextCellDataSourceImpl_h */
