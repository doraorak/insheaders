...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGShareSheetMetadataList_h
#define IGShareSheetMetadataList_h
@import Foundation;
...
@interface IGShareSheetMetadataList : UIView<IGListAdapterDataSource, IGListAdapterDelegate, UICollectionViewDelegate> {
  /* instance variables */
...
@property (weak, nonatomic) NSObject<IGShareSheetMetadataListDelegate> *delegate;
...
#endif /* IGShareSheetMetadataList_h */
