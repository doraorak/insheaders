...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGDirectNotesReactionListSectionController_h
#define IGDirectNotesReactionListSectionController_h
@import Foundation;
...
@protocol IGDirectNotesReactionListSectionControllerDelegate;

@interface IGDirectNotesReactionListSectionController : IGListBindingSectionController<IGListBindingSectionControllerDataSource, IGListBindingSectionControllerSelectionDelegate> {
  /* instance variables */
  NSObject<IGDirectNotesReactionListSectionControllerDelegate> *_delegate;
...
/* instance methods */
- (id)initWithFeedbackModel:(id)model delegate:(id)delegate;
...
- (void)didTapReactionCell:(id)cell viewModel:(id)model;
@end

#endif /* IGDirectNotesReactionListSectionController_h */
