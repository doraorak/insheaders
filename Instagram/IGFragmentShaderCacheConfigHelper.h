...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGFragmentShaderCacheConfigHelper_h
#define IGFragmentShaderCacheConfigHelper_h
@import Foundation;
...
@interface IGFragmentShaderCacheConfigHelper : NSObject<METAMediaCompositionConfigHelperEntryProtocol> {
  /* instance variables */
...
#endif /* IGFragmentShaderCacheConfigHelper_h */
