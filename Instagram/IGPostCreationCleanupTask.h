...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGPostCreationCleanupTask_h
#define IGPostCreationCleanupTask_h
@import Foundation;
...
@interface IGPostCreationCleanupTask : NSObject<NSObject> {
  /* instance variables */
...
/* instance methods */
- (id)initWithFileManager:(id)manager postCreationURL:(id)url stagingURL:(id)url folder:(id)folder thresholdDate:(id)date;
...
#endif /* IGPostCreationCleanupTask_h */
