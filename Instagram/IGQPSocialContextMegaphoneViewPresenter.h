...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGQPSocialContextMegaphoneViewPresenter_h
#define IGQPSocialContextMegaphoneViewPresenter_h
@import Foundation;
...
@protocol IGQPViewPresenterDelegate, UIView<IGQPMegaphoneViewProtocol;

@interface IGQPSocialContextMegaphoneViewPresenter : NSObject<IGQPMegaphoneViewDelegate> {
  /* instance variables */
...
#endif /* IGQPSocialContextMegaphoneViewPresenter_h */
