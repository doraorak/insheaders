...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGQuestionStickerResponseSendMessageButton_h
#define IGQuestionStickerResponseSendMessageButton_h
@import Foundation;
...
#endif /* IGQuestionStickerResponseSendMessageButton_h */
