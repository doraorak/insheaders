...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGTaggedMediaThumbnailConfiguration_h
#define IGTaggedMediaThumbnailConfiguration_h
@import Foundation;
...
@interface IGTaggedMediaThumbnailConfiguration : NSObject<IGMediaThumbnailConfigurationType> {
  /* instance variables */
...
#endif /* IGTaggedMediaThumbnailConfiguration_h */
