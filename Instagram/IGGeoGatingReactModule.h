...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGGeoGatingReactModule_h
#define IGGeoGatingReactModule_h
@import Foundation;
...
/* instance methods */
- (void)updateGeoGatingSettings:(BOOL)settings limitLocationList:(id)list settingType:(id)type;
- (void)setupNativeModule;
@end

#endif /* IGGeoGatingReactModule_h */
