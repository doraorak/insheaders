...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGChainingFeedItemConfiguration_h
#define IGChainingFeedItemConfiguration_h
@import Foundation;
...
- (id)initWithUserSession:(id)session analyticsModule:(id)module hideTimestamp:(BOOL)timestamp forceSingleLineCaption:(BOOL)caption seedMediaID:(id)id;
...
#endif /* IGChainingFeedItemConfiguration_h */
