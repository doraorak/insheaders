...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGRegistrationCALStepController_h
#define IGRegistrationCALStepController_h
@import Foundation;
...
@interface IGRegistrationCALStepController : NSObject<NSObject> {
  /* instance variables */
...
#endif /* IGRegistrationCALStepController_h */
