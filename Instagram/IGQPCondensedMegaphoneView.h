...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGQPCondensedMegaphoneView_h
#define IGQPCondensedMegaphoneView_h
@import Foundation;
...
- (void)_didTapContentLabel:(id)label;
...
#endif /* IGQPCondensedMegaphoneView_h */
