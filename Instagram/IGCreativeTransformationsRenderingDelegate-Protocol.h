...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGCreativeTransformationsRenderingDelegate_Protocol_h
#define IGCreativeTransformationsRenderingDelegate_Protocol_h
@import Foundation;
...
#endif /* IGCreativeTransformationsRenderingDelegate_Protocol_h */
