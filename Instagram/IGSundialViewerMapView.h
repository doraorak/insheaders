...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGSundialViewerMapView_h
#define IGSundialViewerMapView_h
@import Foundation;
...
@class IGImmersiveFeedConfiguration, IGPhoto, MKMapView, NSString;

@interface IGSundialViewerMapView : UIView<IGSundialViewerControlsOverlayLayoutDelegate> {
  /* instance variables */
  MKMapView *_mapView;
  IGPhoto *_photo;
  IGSundialViewerMediaBackgroundView *_backgroundView;
  IGImmersiveFeedConfiguration *_immersiveFeedConfig;
...
#endif /* IGSundialViewerMapView_h */
