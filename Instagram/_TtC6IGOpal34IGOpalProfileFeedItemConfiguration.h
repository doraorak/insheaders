...
//    - LC_SOURCE_VERSION: 
//
#ifndef _TtC6IGOpal34IGOpalProfileFeedItemConfiguration_h
#define _TtC6IGOpal34IGOpalProfileFeedItemConfiguration_h
@import Foundation;

#include "IGFeedItemConfigurationType-Protocol.h"

@interface _TtC6IGOpal34IGOpalProfileFeedItemConfiguration : NSObject<IGFeedItemConfigurationType> { // (Swift)
  /* instance variables */
   defaultConfig;
   localCtaPresenterContext;
   userSession;
}
...
#endif /* _TtC6IGOpal34IGOpalProfileFeedItemConfiguration_h */
