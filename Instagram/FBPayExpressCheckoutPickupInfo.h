...
//    - LC_SOURCE_VERSION: 
//
#ifndef FBPayExpressCheckoutPickupInfo_h
#define FBPayExpressCheckoutPickupInfo_h
@import Foundation;
...
@interface FBPayExpressCheckoutPickupInfo : FBValueObject<NSCopying, NSCoding>
...
@property (readonly, copy, nonatomic) FBPaymentsContactInfoPhoneNumberDataModel *pickupPhone;
...
#endif /* FBPayExpressCheckoutPickupInfo_h */
