...
//    - LC_SOURCE_VERSION: 
//
#ifndef _TtC17IGStorySharedList41IGStorySharedListMemberListViewController_h
#define _TtC17IGStorySharedList41IGStorySharedListMemberListViewController_h
@import Foundation;

#include "IGViewController.h"

@interface _TtC17IGStorySharedList41IGStorySharedListMemberListViewController : IGViewController { // (Swift)
  /* instance variables */
   userSession;
   delegate;
   sharedList;
...
#endif /* _TtC17IGStorySharedList41IGStorySharedListMemberListViewController_h */
