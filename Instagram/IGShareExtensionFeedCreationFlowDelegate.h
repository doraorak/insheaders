...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGShareExtensionFeedCreationFlowDelegate_h
#define IGShareExtensionFeedCreationFlowDelegate_h
@import Foundation;
...
@interface IGShareExtensionFeedCreationFlowDelegate : NSObject<IGFeedCreationFlowDelegate> {
  /* instance variables */
...
#endif /* IGShareExtensionFeedCreationFlowDelegate_h */
