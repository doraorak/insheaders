...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGDirectAgentsFeedbackMegaphoneActionHandler_h
#define IGDirectAgentsFeedbackMegaphoneActionHandler_h
@import Foundation;
...
@interface IGDirectAgentsFeedbackMegaphoneActionHandler : NSObject<IGDirectThreadMegaphoneActionHandler> {
  /* instance variables */
...
/* instance methods */
- (id)initWithUserDefaults:(id)defaults threadTitle:(id)title;
...
#endif /* IGDirectAgentsFeedbackMegaphoneActionHandler_h */
