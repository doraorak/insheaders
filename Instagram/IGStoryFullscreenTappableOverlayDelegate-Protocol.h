...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGStoryFullscreenTappableOverlayDelegate_Protocol_h
#define IGStoryFullscreenTappableOverlayDelegate_Protocol_h
@import Foundation;
...
#endif /* IGStoryFullscreenTappableOverlayDelegate_Protocol_h */
