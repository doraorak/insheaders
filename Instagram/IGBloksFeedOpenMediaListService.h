...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGBloksFeedOpenMediaListService_h
#define IGBloksFeedOpenMediaListService_h
@import Foundation;

#include "IGFeedNetworkSourceDelegate-Protocol.h"

@class IGFeedNetworkSource, IGUserSession, NSMutableSet, NSString;

@interface IGBloksFeedOpenMediaListService : NSObject<IGFeedNetworkSourceDelegate> {
  /* instance variables */
  ...
  NSMutableSet *_fetchedMediaCache;
}
...
#endif /* IGBloksFeedOpenMediaListService_h */
