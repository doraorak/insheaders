...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGLiveBroadcastShareToStoryImageStickerView_h
#define IGLiveBroadcastShareToStoryImageStickerView_h
@import Foundation;

#include "UIView.h"
#include "IGStickerViewType-Protocol.h"

@class IGImageStickerView, IGStoryStickerExportModel, NSString;

@interface IGLiveBroadcastShareToStoryImageStickerView : UIView<IGStickerViewType> {
  /* instance variables */
  IGImageStickerView *_imageView;
}
...
#endif /* IGLiveBroadcastShareToStoryImageStickerView_h */
