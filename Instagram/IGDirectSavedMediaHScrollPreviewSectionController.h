...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGDirectSavedMediaHScrollPreviewSectionController_h
#define IGDirectSavedMediaHScrollPreviewSectionController_h
@import Foundation;
...
@interface IGDirectSavedMediaHScrollPreviewSectionController : IGListBindingSingleSectionController<IGListDisplayDelegate> {
  /* instance variables */
...
/* instance methods */
- (id)initWithUserSession:(id)session threadId:(id)id analyticsModule:(id)module;
- (Class)cellClass;
...
#endif /* IGDirectSavedMediaHScrollPreviewSectionController_h */
