...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGFinstaPromotionMegaphonePresenter_h
#define IGFinstaPromotionMegaphonePresenter_h
@import Foundation;
...
@class IGAddAccountManager, IGUserSession, NSString, UIView;
@protocol IGMegaphonePresenterDelegate;

@interface IGFinstaPromotionMegaphonePresenter : NSObject<IGMegaphonePresenterProtocol> {
  /* instance variables */
...
#endif /* IGFinstaPromotionMegaphonePresenter_h */
