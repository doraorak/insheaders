...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGStoryCommentComposerView_h
#define IGStoryCommentComposerView_h
@import Foundation;
...
@class IGDirectComposer, IGProfilePictureImageView, IGUserSession, NSString, UILabel, UITapGestureRecognizer, UIView;
@protocol IGStoryCommentComposerViewDelegate;

@interface IGStoryCommentComposerView : UIView<IGDirectComposerButtonDelegate, IGDirectComposerTextListener> {
  /* instance variables */
  UILabel *_charLimitLabel;
  struct CGSize { double width; double height; } _charLimitLabelMaxSize;
  UIView *_dismissTapView;
  UITapGestureRecognizer *_dismissTapGesture;
  IGUserSession *_userSession;
  IGDirectComposer *_composer;
  IGProfilePictureImageView *_profileImageView;
  IGStoryHypePreviewView *_hypePreviewView;
  _TtC23IGStoryCommentsHypeTail25IGStoryCommentsHypeBubble *_hypeBubble;
}

@property (weak, nonatomic) NSObject<IGStoryCommentComposerViewDelegate> *delegate;
...
#endif /* IGStoryCommentComposerView_h */
