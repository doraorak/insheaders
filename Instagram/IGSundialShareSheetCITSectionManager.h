...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGSundialShareSheetCITSectionManager_h
#define IGSundialShareSheetCITSectionManager_h
@import Foundation;

#include "_TtP26IGSundialShareSheetContext34IGSundialShareSheetSectionManaging_-Protocol.h"

@interface IGSundialShareSheetCITSectionManager : NSObject<_TtP26IGSundialShareSheetContext34IGSundialShareSheetSectionManaging_> { // (Swift)
  /* instance variables */
   dataSource;
   context;
}
...
#endif /* IGSundialShareSheetCITSectionManager_h */
