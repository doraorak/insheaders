...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGReactAnalyticsLogger_h
#define IGReactAnalyticsLogger_h
@import Foundation;

#include "NativeAnalyticsSpec-Protocol.h"
#include "RCTBridge.h"
...
/* instance methods */
- (void)logEvent:(id)event data:(id)data analyticsModule:(id)module;
- (void)logRealtimeEvent:(id)event data:(id)data analyticsModule:(id)module;
- (void)logCounter:(id)counter value:(double)value;
...
#endif /* IGReactAnalyticsLogger_h */
