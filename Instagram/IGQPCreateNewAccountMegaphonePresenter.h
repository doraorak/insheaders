...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGQPCreateNewAccountMegaphonePresenter_h
#define IGQPCreateNewAccountMegaphonePresenter_h
@import Foundation;

#include "IGQPMegaphoneView.h"
#include "IGQPMegaphoneViewDelegate-Protocol.h"

@class IGAddAccountManager, IGUserSession, NSString;
@protocol IGQPViewPresenterDelegate;

@interface IGQPCreateNewAccountMegaphonePresenter : NSObject<IGQPMegaphoneViewDelegate> {
  /* instance variables */
...
#endif /* IGQPCreateNewAccountMegaphonePresenter_h */
