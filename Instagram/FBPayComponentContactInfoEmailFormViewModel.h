...
//    - LC_SOURCE_VERSION: 
//
#ifndef FBPayComponentContactInfoEmailFormViewModel_h
#define FBPayComponentContactInfoEmailFormViewModel_h
@import Foundation;
...
/* instance methods */
- (id)initWithHeaderConfiguration:(id)configuration emailDataModel:(id)model fieldConfig:(id)config shouldSetDefault:(BOOL)default oneTimeCheckoutModel:(id)model logger:(id)logger shouldEnableOSAutofill:(BOOL)osautofill ecpContext:(id)context;
...
#endif /* FBPayComponentContactInfoEmailFormViewModel_h */
