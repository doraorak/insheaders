...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGAvatarStickerStoryPreCaptureHelper_h
#define IGAvatarStickerStoryPreCaptureHelper_h
@import Foundation;

#include "IGCreationViewControllerNavigationDelegate-Protocol.h"

@class IGAvatarStickerUpsellModel, IGUserSession, NSString;

@interface IGAvatarStickerStoryPreCaptureHelper : NSObject<IGCreationViewControllerNavigationDelegate> {
  /* instance variables */
  IGUserSession *_userSession;
  NSObject<IGCreationViewControllerNavigationDelegate> *_storyNavigationDelegate;
  id /* block */ _dismissUpsellHandler;
  IGAvatarStickerUpsellModel *_stickerModel;
}
...
#endif /* IGAvatarStickerStoryPreCaptureHelper_h */
