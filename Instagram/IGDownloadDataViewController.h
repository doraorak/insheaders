...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGDownloadDataViewController_h
#define IGDownloadDataViewController_h
@import Foundation;

#include "IGGroupedTableViewController.h"
#include "IGDownloadDataView.h"
...
@interface IGDownloadDataViewController : IGGroupedTableViewController<IGKeyboardObserverShowDelegate, IGKeyboardObserverHideDelegate, UIGestureRecognizerDelegate> {
  /* instance variables */
  IGUserSession *_userSession;
  IGDownloadDataView *_downloadView;
  IGKeyboardObserver *_keyboardObserver;
  BOOL _isFetchingDownloadStatus;
...
#endif /* IGDownloadDataViewController_h */
