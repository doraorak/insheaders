...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGGuideCoverMediaPickerLibraryViewController_h
#define IGGuideCoverMediaPickerLibraryViewController_h
@import Foundation;
...
@class IGGalleryDataSource, IGPhotoLibraryLimitedAccessHeaderView, IGUserSession, NSString, UICollectionView;
@protocol IGGuideCoverMediaPickerLibraryViewControllerDelegate;
...
@property (weak, nonatomic) NSObject<IGGuideCoverMediaPickerLibraryViewControllerDelegate> *delegate;
...
#endif /* IGGuideCoverMediaPickerLibraryViewController_h */
