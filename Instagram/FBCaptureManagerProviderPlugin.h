...
//    - LC_SOURCE_VERSION: 
//
#ifndef FBCaptureManagerProviderPlugin_h
#define FBCaptureManagerProviderPlugin_h
@import Foundation;
...
@interface FBCaptureManagerProviderPlugin : NSObject<NSObject>
...
#endif /* FBCaptureManagerProviderPlugin_h */
