...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGConfirmEmailMegaphonePresenter_h
#define IGConfirmEmailMegaphonePresenter_h
@import Foundation;
...
@interface IGConfirmEmailMegaphonePresenter : NSObject<IGMegaphonePresenterProtocol, IGScopedListener> {
  /* instance variables */
...
#endif /* IGConfirmEmailMegaphonePresenter_h */
