...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGProfileAndTrailingButtonViewProvider_h
#define IGProfileAndTrailingButtonViewProvider_h
@import Foundation;

#include "IGProfileAndTrailingButtonControllerDelegate-Protocol.h"
#include "IGProfileAndTrailingButtonViewModel.h"
#include "IGProfilePictureImageViewTapDelegate-Protocol.h"

@class IGProfileCellBodyView, IGProfilePictureImageView, IGTableLayoutSpec, IGTapButton, IGTextButton, NSString, UIView;
@protocol IGListItemViewProviderDelegate;

@interface IGProfileAndTrailingButtonViewProvider : NSObject<IGProfilePictureImageViewTapDelegate> {
  /* instance variables */
...
@property (weak, nonatomic) NSObject<IGProfileAndTrailingButtonControllerDelegate> *delegate;
@property (retain, nonatomic) IGProfileAndTrailingButtonViewModel *viewModel;
...
#endif /* IGProfileAndTrailingButtonViewProvider_h */
