...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGGuideCreationSearchClickHandler_h
#define IGGuideCreationSearchClickHandler_h
@import Foundation;
...
@class NSString;
@protocol IGGuideCreationSearchClickHandlerDelegate;

@interface IGGuideCreationSearchClickHandler : NSObject<IGSearchClickHandler>

@property (weak, nonatomic) NSObject<IGGuideCreationSearchClickHandlerDelegate> *delegate;
...
#endif /* IGGuideCreationSearchClickHandler_h */
