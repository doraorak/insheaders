...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGDescriptionViewProvider_h
#define IGDescriptionViewProvider_h
@import Foundation;

#include "NSObject-Protocol.h"

@class IGTableLayoutSpec, NSString, UILabel;
@protocol IGListItemViewProviderDelegate;

@interface IGDescriptionViewProvider : NSObject<NSObject> {
  /* instance variables */
  UILabel *_label;
}
...
#endif /* IGDescriptionViewProvider_h */
