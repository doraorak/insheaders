...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGReportingComponentFollowupItemViewProvider_h
#define IGReportingComponentFollowupItemViewProvider_h
@import Foundation;
...
@interface IGReportingComponentFollowupItemViewProvider : NSObject<NSObject> {
  /* instance variables */
...
- (BOOL)shouldShowActionSubtitle:(unsigned long long)subtitle;
...
#endif /* IGReportingComponentFollowupItemViewProvider_h */
