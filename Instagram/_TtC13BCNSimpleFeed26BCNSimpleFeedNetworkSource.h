...
//    - LC_SOURCE_VERSION: 
//
#ifndef _TtC13BCNSimpleFeed26BCNSimpleFeedNetworkSource_h
#define _TtC13BCNSimpleFeed26BCNSimpleFeedNetworkSource_h
@import Foundation;

#include "IGNetworkSourceDelegate-Protocol.h"

@interface _TtC13BCNSimpleFeed26BCNSimpleFeedNetworkSource : NSObject<IGNetworkSourceDelegate> { // (Swift)
  /* instance variables */
   delegate;
   hasFetchedOnce;
   path;
...
#endif /* _TtC13BCNSimpleFeed26BCNSimpleFeedNetworkSource_h */
