...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGDevicePermissionAdsTrackingCoreAPI_h
#define IGDevicePermissionAdsTrackingCoreAPI_h
@import Foundation;
...
@interface IGDevicePermissionAdsTrackingCoreAPI : DevicePermissionCoreAPI<NSObject> {
  /* instance variables */
...
#endif /* IGDevicePermissionAdsTrackingCoreAPI_h */
