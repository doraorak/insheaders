...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGStoryViewerUnreadAttributionController_h
#define IGStoryViewerUnreadAttributionController_h
@import Foundation;
...
@interface IGStoryViewerUnreadAttributionController : NSObject<IGStoryViewerHeaderAttributionType> {
  /* instance variables */
  NSString *_title;
}
...
/* instance methods */
- (id)initWithTitle:(id)title reelId:(id)id;
...
#endif /* IGStoryViewerUnreadAttributionController_h */
