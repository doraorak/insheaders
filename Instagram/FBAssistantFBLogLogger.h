...
//    - LC_SOURCE_VERSION: 
//
#ifndef FBAssistantFBLogLogger_h
#define FBAssistantFBLogLogger_h
@import Foundation;
...
@interface FBAssistantFBLogLogger : NSObject<FBAssistantConsoleLogging>
...
#endif /* FBAssistantFBLogLogger_h */
