...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGPurchaseOptionCellViewProvider_h
#define IGPurchaseOptionCellViewProvider_h
@import Foundation;
...
@interface IGPurchaseOptionCellViewProvider : NSObject<NSObject> {
  /* instance variables */
...
@property (retain, nonatomic) UIImageView *trailingContentView;
...
#endif /* IGPurchaseOptionCellViewProvider_h */
