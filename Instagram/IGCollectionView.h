...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGCollectionView_h
#define IGCollectionView_h
@import Foundation;
...
@interface IGCollectionView : UICollectionView {
  /* instance variables */
  BOOL _inSetContentOffset;
}

/* class methods */
+ (id)newWithFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })frame collectionViewLayout:(id)layout;
