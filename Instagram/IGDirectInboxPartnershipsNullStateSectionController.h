...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGDirectInboxPartnershipsNullStateSectionController_h
#define IGDirectInboxPartnershipsNullStateSectionController_h
@import Foundation;

#include "IGListBindingSingleSectionController.h"
#include "IGDirectInboxPartnershipsNullStateViewModel.h"
#include "IGListDisplayDelegate-Protocol.h"

@class IGUserSession, NSString;

@interface IGDirectInboxPartnershipsNullStateSectionController : IGListBindingSingleSectionController<IGListDisplayDelegate> {
  /* instance variables */
  IGUserSession *_session;
}

@property (retain, nonatomic) IGDirectInboxPartnershipsNullStateViewModel *viewModel;
...
#endif /* IGDirectInboxPartnershipsNullStateSectionController_h */
