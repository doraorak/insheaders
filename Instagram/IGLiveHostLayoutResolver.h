...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGLiveHostLayoutResolver_h
#define IGLiveHostLayoutResolver_h
@import Foundation;
...
@interface IGLiveHostLayoutResolver : NSObject<NSObject>
...
#endif /* IGLiveHostLayoutResolver_h */
