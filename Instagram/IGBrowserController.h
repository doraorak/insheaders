...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGBrowserController_h
#define IGBrowserController_h
@import Foundation;

#include "IGBrowserViewControllerDelegate-Protocol.h"

@class NSString, UIViewController;
@protocol IGBrowserControllerDelegate, IGBrowserControllerLandingPageDelegate;
...
@property (weak, nonatomic) NSObject<IGBrowserControllerDelegate> *delegate;
@property (weak, nonatomic) NSObject<IGBrowserControllerLandingPageDelegate> *landingPageDelegate;
