...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGProfileSideTrayProject92SectionController_h
#define IGProfileSideTrayProject92SectionController_h
@import Foundation;
...
@interface IGProfileSideTrayProject92SectionController : IGListSectionController<IGBadgeListener, IGSideTrayItemSectionController> {
  /* instance variables */
...
#endif /* IGProfileSideTrayProject92SectionController_h */
