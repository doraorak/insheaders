...
//    - LC_SOURCE_VERSION: 
//
#ifndef FBPaymentsContactInfo_h
#define FBPaymentsContactInfo_h
@import Foundation;
...
/* instance methods */
- (id)initWithId:(id)id isDefault:(BOOL)default normalizedValue:(id)value;
@end

#endif /* FBPaymentsContactInfo_h */
