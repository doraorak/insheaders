...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGLiveSuggestionBroadcastDataSource_h
#define IGLiveSuggestionBroadcastDataSource_h
@import Foundation;
...
@property (readonly, copy, nonatomic) NSArray *liveBroadcasts;
@property (weak, nonatomic) NSObject<IGLiveSuggestionBroadcastDataSourceDelegate> *delegate;
...
#endif /* IGLiveSuggestionBroadcastDataSource_h */
