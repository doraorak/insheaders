...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGDeletedMediaNavigationService_h
#define IGDeletedMediaNavigationService_h
@import Foundation;
...
@class IGActionableConfirmationToastController, IGFeedNetworkSource, IGUserSession, NSString, UINavigationController;

@interface IGDeletedMediaNavigationService : NSObject<IGFeedNetworkSourceDelegate, IGScopedListener> {
  /* instance variables */
  ...
  id /* block */ _onMediaRestoredOrHardDeleted;
}
...
/* instance methods */
- (id)initWithUserSession:(id)session onMediaRestoredOrHardDeleted:(id /* block */)deleted;
...
#endif /* IGDeletedMediaNavigationService_h */
