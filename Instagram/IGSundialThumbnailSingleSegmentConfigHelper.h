...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGSundialThumbnailSingleSegmentConfigHelper_h
#define IGSundialThumbnailSingleSegmentConfigHelper_h
@import Foundation;
...
@interface IGSundialThumbnailSingleSegmentConfigHelper : NSObject<METAMediaCompositionConfigHelperEntryProtocol> {
  /* instance variables */
...
#endif /* IGSundialThumbnailSingleSegmentConfigHelper_h */
