...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGDiscoveryGridAdCTAButton_h
#define IGDiscoveryGridAdCTAButton_h
@import Foundation;
...
@class IGMedia, NSNumber, NSString, UIColor;

@interface IGDiscoveryGridAdCTAButton : IGALButton<IGFeedItemCTAButtonCellConfigurable> {
  /* instance variables */
...
#endif /* IGDiscoveryGridAdCTAButton_h */
