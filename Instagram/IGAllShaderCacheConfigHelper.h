...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGAllShaderCacheConfigHelper_h
#define IGAllShaderCacheConfigHelper_h
@import Foundation;
...
@interface IGAllShaderCacheConfigHelper : NSObject<METAMediaCompositionConfigHelperEntryProtocol> {
  /* instance variables */
...
#endif /* IGAllShaderCacheConfigHelper_h */
