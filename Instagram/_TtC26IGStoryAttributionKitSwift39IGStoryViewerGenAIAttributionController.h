...
//    - LC_SOURCE_VERSION: 
//
#ifndef _TtC26IGStoryAttributionKitSwift39IGStoryViewerGenAIAttributionController_h
#define _TtC26IGStoryAttributionKitSwift39IGStoryViewerGenAIAttributionController_h
@import Foundation;
...
@interface _TtC26IGStoryAttributionKitSwift39IGStoryViewerGenAIAttributionController : NSObject<IGStoryViewerHeaderAttributionType> { // (Swift)
  /* instance variables */
   userSession;
   media;
}
...
#endif /* _TtC26IGStoryAttributionKitSwift39IGStoryViewerGenAIAttributionController_h */
