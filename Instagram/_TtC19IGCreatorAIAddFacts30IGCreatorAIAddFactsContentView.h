...
//    - LC_SOURCE_VERSION: 
//
#ifndef _TtC19IGCreatorAIAddFacts30IGCreatorAIAddFactsContentView_h
#define _TtC19IGCreatorAIAddFacts30IGCreatorAIAddFactsContentView_h
@import Foundation;

#include "IGBaseView.h"
#include "IGGrowingTextViewDelegate-Protocol.h"

@interface _TtC19IGCreatorAIAddFacts30IGCreatorAIAddFactsContentView : IGBaseView<IGGrowingTextViewDelegate> { // (Swift)
  /* instance variables */
   onFieldDidChangeText;
   insets;
   questionLabel;
   questionInput;
   questionDivider;
...
#endif /* _TtC19IGCreatorAIAddFacts30IGCreatorAIAddFactsContentView_h */
