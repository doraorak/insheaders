...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGStoryResearchPollView_h
#define IGStoryResearchPollView_h
@import Foundation;

#include "UIView.h"
#include "IGStoryPlayerMediaViewDelegate-Protocol.h"
#include "IGStoryPlayerMediaViewType-Protocol.h"
#include "IGStoryResearchPollQuestionView.h"
...
@class CALayer, IGBrandLiftSurvey, NSString;

@interface IGStoryResearchPollView : UIView<IGStoryStaticMediaProgressManagerDelegate, IGStoryPlayerMediaViewType> {
  /* instance variables */
  CALayer *_gradientLayer;
  IGStoryStaticMediaProgressManager *_progressManager;
  NSObject<IGStoryPlayerMediaViewDelegate> *_playerMediaViewDelegate;
  IGBrandLiftSurvey *_surveyModel;
  IGStoryResearchPollQuestionView *_questionView;
}
...
#endif /* IGStoryResearchPollView_h */
