...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGSundialViewerCarouselCell_h
#define IGSundialViewerCarouselCell_h
@import Foundation;
...
@class IGAccessibilityCollectionController, IGImmersiveFeedConfiguration, IGMedia, IGUserSession, IGVideoPlaybackLoggingConfig, NSArray, NSMutableDictionary, NSString, UICollectionViewFlowLayout;
@protocol IGSundialViewerCarouselCellDelegate;

@interface IGSundialViewerCarouselCell : UICollectionViewCell<IGSundialViewerControlsOverlayLayoutDelegate, UICollectionViewDataSource, UICollectionViewDelegate, IGHeartAnimatable, IGMediaViewProvider, IGSundialAudioToggleable, IGSundialControlsOverlaySupporting, IGSundialPlaybackIsPlaying, IGSundialViewerInteractionCellType, IGFeedAudioPlayable, IGSundialLinkedHighlightCompatible> {
  /* instance variables */
  ...
  NSObject<IGPlaybackCoordinatorSession> *_playbackSession;
  IGMedia *_media;
  NSArray *_items;
...
@property (readonly, weak, nonatomic) NSObject<IGSundialViewerCarouselCellDelegate> *delegate;
...
#endif /* IGSundialViewerCarouselCell_h */
