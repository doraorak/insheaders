...
//    - LC_SOURCE_VERSION: 
//
#ifndef BCNQPMainFeedMegaphonePresenter_h
#define BCNQPMainFeedMegaphonePresenter_h
@import Foundation;

#include "BCNQPMainFeedMegaphoneView.h"
...
@interface BCNQPMainFeedMegaphonePresenter : NSObject<IGQPMegaphoneViewDelegate> {
  /* instance variables */
  IGQPMegaphone *_megaphone;
  BCNQPMainFeedMegaphoneView *_megaphoneView;
...
#endif /* BCNQPMainFeedMegaphonePresenter_h */
