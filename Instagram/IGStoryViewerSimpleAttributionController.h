...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGStoryViewerSimpleAttributionController_h
#define IGStoryViewerSimpleAttributionController_h
@import Foundation;
...
@interface IGStoryViewerSimpleAttributionController : NSObject<IGStoryViewerHeaderAttributionType> {
  /* instance variables */
  NSString *_title;
  UIImage *_icon;
}
...
/* instance methods */
- (id)initWithTitle:(id)title accessoryIcon:(id)icon;
...
#endif /* IGStoryViewerSimpleAttributionController_h */
