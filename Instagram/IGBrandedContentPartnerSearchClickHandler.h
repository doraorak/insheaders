...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGBrandedContentPartnerSearchClickHandler_h
#define IGBrandedContentPartnerSearchClickHandler_h
@import Foundation;

#include "IGBrandedContentAddPartnerTaggingHandler.h"
...
/* instance methods */
- (id)initWithAddPartnerTaggingHandler:(id)handler isRequestApprovalsFlow:(BOOL)flow;
...
#endif /* IGBrandedContentPartnerSearchClickHandler_h */
