...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGSundialEffectsPagePerformanceLogger_h
#define IGSundialEffectsPagePerformanceLogger_h
@import Foundation;
...
@interface IGSundialEffectsPagePerformanceLogger : NSObject<IGSundialGridPerformanceLogger> {
  /* instance variables */
  NSString *_effectID;
  IGPerformanceComponent *_effectPageGrid;
...
#endif /* IGSundialEffectsPagePerformanceLogger_h */
