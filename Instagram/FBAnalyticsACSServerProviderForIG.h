...
//    - LC_SOURCE_VERSION: 
//
#ifndef FBAnalyticsACSServerProviderForIG_h
#define FBAnalyticsACSServerProviderForIG_h
@import Foundation;
...
@interface FBAnalyticsACSServerProviderForIG : NSObject<ACSServerProvider> {
  /* instance variables */
...
#endif /* FBAnalyticsACSServerProviderForIG_h */
