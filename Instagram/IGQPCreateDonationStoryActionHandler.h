...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGQPCreateDonationStoryActionHandler_h
#define IGQPCreateDonationStoryActionHandler_h
@import Foundation;
...
@interface IGQPCreateDonationStoryActionHandler : NSObject<IGCreationViewControllerNavigationDelegate, IGQPActionHandlerProtocol> {
  /* instance variables */
...
#endif /* IGQPCreateDonationStoryActionHandler_h */
