...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGProfileTabViewControllerDelegate_Protocol_h
#define IGProfileTabViewControllerDelegate_Protocol_h
@import Foundation;
...
#endif /* IGProfileTabViewControllerDelegate_Protocol_h */
