...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGPermalinkFeedItemConfiguration_h
#define IGPermalinkFeedItemConfiguration_h
@import Foundation;
...
- (id)initWithSingleFeedItemConfiguration:(id)configuration;
...
#endif /* IGPermalinkFeedItemConfiguration_h */
