...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGDirectAggregatedMediaCell_h
#define IGDirectAggregatedMediaCell_h
@import Foundation;
...
@class IGDirectAggregatedMedia, IGDirectMessageBlurredImageView, IGImageView, IGMediaLoggingSecurePersistentIdGenerator, NSString, UIImageView;
@protocol IGDirectAggregatedMediaCellDelegate;

@interface IGDirectAggregatedMediaCell : UICollectionViewCell<IGImageViewDelegate> {
  /* instance variables */
...
@property (weak, nonatomic) NSObject<IGDirectAggregatedMediaCellDelegate> *delegate;
...
#endif /* IGDirectAggregatedMediaCell_h */
