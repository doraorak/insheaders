...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGDirectShareSheetControllerDelegate_Protocol_h
#define IGDirectShareSheetControllerDelegate_Protocol_h
@import Foundation;
...
#endif /* IGDirectShareSheetControllerDelegate_Protocol_h */
