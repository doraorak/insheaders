...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGSundialAudioBrowserContentViewController_h
#define IGSundialAudioBrowserContentViewController_h
@import Foundation;
...
@class IGAudioBrowserModelsListViewController, NSArray, NSString;
@protocol IGSundialAudioBrowserContentViewControllerDelegate;

@interface IGSundialAudioBrowserContentViewController : UIViewController<IGAudioBrowserModelsListViewControllerDelegate, IGAnalyticsModule> {
  /* instance variables */
...
@property (weak, nonatomic) NSObject<IGSundialAudioBrowserContentViewControllerDelegate> *delegate;
...
/* instance methods */
- (id)initWithTracksRequest:(id)request userSession:(id)session analyticsModule:(id)module logger:(id)logger;
- (void)viewDidLoad;
...
#endif /* IGSundialAudioBrowserContentViewController_h */
