...
//    - LC_SOURCE_VERSION: 
//
#ifndef _TtC6IGOpal42IGOpalEditProfileGenericTextViewController_h
#define _TtC6IGOpal42IGOpalEditProfileGenericTextViewController_h
@import Foundation;

#include "IGViewController.h"

@interface _TtC6IGOpal42IGOpalEditProfileGenericTextViewController : IGViewController { // (Swift)
  /* instance variables */
   delegate;
   userSession;
   identifier;
   ...
   $__lazy_storage_$_textViewController;
}
...
#endif /* _TtC6IGOpal42IGOpalEditProfileGenericTextViewController_h */
