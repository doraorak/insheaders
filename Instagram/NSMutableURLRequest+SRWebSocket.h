...
//    - LC_SOURCE_VERSION: 
//
#ifndef NSMutableURLRequest_SRWebSocket_h
#define NSMutableURLRequest_SRWebSocket_h
@import Foundation;
...
/* instance methods */
- (void)setSR_SSLPinnedCertificates:(id)certificates;
@end

#endif /* NSMutableURLRequest_SRWebSocket_h */
