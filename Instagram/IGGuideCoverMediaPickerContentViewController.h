...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGGuideCoverMediaPickerContentViewController_h
#define IGGuideCoverMediaPickerContentViewController_h
@import Foundation;
...
@interface IGGuideCoverMediaPickerContentViewController : IGViewController<IGFeedNetworkSourceDelegate, IGScrollViewListener, IGListAdapterDataSource, IGMediaThumbnailSectionControllerSelectionDelegate> {
  /* instance variables */
...
@property (weak, nonatomic) NSObject<IGGuideCoverMediaPickerContentViewControllerDelegate> *delegate;
...
/* instance methods */
- (id)initWithUserSession:(id)session feedNetworkSource:(id)source;
- (id)initWithUserSession:(id)session guideMediaItems:(id)items;
- (id)initWithUserSession:(id)session feedNetworkSource:(id)source guideMediaItems:(id)items;
- (void)viewDidLoad;
- (void)_fetchMedia;
...
#endif /* IGGuideCoverMediaPickerContentViewController_h */
