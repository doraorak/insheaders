...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGNUXOneTapStepController_h
#define IGNUXOneTapStepController_h
@import Foundation;
...
@interface IGNUXOneTapStepController : NSObject<NSObject> {
  /* instance variables */
...
#endif /* IGNUXOneTapStepController_h */
