...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGCPDPHeroCarouselVideoLightboxComponentController_h
#define IGCPDPHeroCarouselVideoLightboxComponentController_h
@import Foundation;
...
#endif /* IGCPDPHeroCarouselVideoLightboxComponentController_h */
