...
//    - LC_SOURCE_VERSION: 
//
#ifndef _TtC8IGEvents25IGEventsNuxViewController_h
#define _TtC8IGEvents25IGEventsNuxViewController_h
@import Foundation;

#include "IGViewController.h"

@interface _TtC8IGEvents25IGEventsNuxViewController : IGViewController { // (Swift)
  /* instance variables */
   userSession;
   nuxType;
   viewModels;
...
#endif /* _TtC8IGEvents25IGEventsNuxViewController_h */
