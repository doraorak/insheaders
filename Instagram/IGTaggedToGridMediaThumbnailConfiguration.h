...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGTaggedToGridMediaThumbnailConfiguration_h
#define IGTaggedToGridMediaThumbnailConfiguration_h
@import Foundation;
...
@interface IGTaggedToGridMediaThumbnailConfiguration : NSObject<IGMediaThumbnailConfigurationType> {
  /* instance variables */
...
/* instance methods */
- (id)initWithSurfaceOwnerPk:(id)pk;
- (BOOL)allowSelection;
- (BOOL)showHighlight;
...
#endif /* IGTaggedToGridMediaThumbnailConfiguration_h */
