...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGStoryTopTrayMediaPreviewView_h
#define IGStoryTopTrayMediaPreviewView_h
@import Foundation;
...
@interface IGStoryTopTrayMediaPreviewView : UIView<IGImageViewDelegate, IGStoryTrayBaseCell> {
  /* instance variables */
...
#endif /* IGStoryTopTrayMediaPreviewView_h */
