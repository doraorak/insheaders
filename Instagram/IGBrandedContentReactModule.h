...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGBrandedContentReactModule_h
#define IGBrandedContentReactModule_h
@import Foundation;
...
/* instance methods */
- (void)openRequestAdCreationAccess:(double)access;
- (void)openAdCreationPartners:(double)partners;
- (void)openAllowlistedPartners:(double)partners allowlistedPartners:(id)partners;
@end

#endif /* IGBrandedContentReactModule_h */
