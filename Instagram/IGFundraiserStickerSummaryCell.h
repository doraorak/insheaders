...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGFundraiserStickerSummaryCell_h
#define IGFundraiserStickerSummaryCell_h
@import Foundation;
...
@property (weak, nonatomic) NSObject<IGFundraiserStickerSummaryCellDelegate> *delegate;
@property (retain, nonatomic) NSString *beneficiaryUsername;
...
#endif /* IGFundraiserStickerSummaryCell_h */
