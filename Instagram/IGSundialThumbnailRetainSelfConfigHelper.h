...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGSundialThumbnailRetainSelfConfigHelper_h
#define IGSundialThumbnailRetainSelfConfigHelper_h
@import Foundation;
...
@interface IGSundialThumbnailRetainSelfConfigHelper : NSObject<METAMediaCompositionConfigHelperEntryProtocol> {
  /* instance variables */
...
#endif /* IGSundialThumbnailRetainSelfConfigHelper_h */
