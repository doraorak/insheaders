...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGRegistrationCALAccountsStepController_h
#define IGRegistrationCALAccountsStepController_h
@import Foundation;
...
@interface IGRegistrationCALAccountsStepController : NSObject<NSObject> {
  /* instance variables */
...
#endif /* IGRegistrationCALAccountsStepController_h */
