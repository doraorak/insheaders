...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGUserScopedObjects_IGARAdsPrefetcher_h
#define IGUserScopedObjects_IGARAdsPrefetcher_h
@import Foundation;
...
@interface IGUserScopedObjects (IGARAdsPrefetcher)
/* instance methods */
- (id)arAdsPrefetcher;
@end

#endif /* IGUserScopedObjects_IGARAdsPrefetcher_h */
