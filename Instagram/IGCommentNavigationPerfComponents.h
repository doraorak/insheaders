...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGCommentNavigationPerfComponents_h
#define IGCommentNavigationPerfComponents_h
@import Foundation;
...
@property (readonly, nonatomic) IGPerformanceComponent *thread;

/* instance methods */
- (id)init;
@end

#endif /* IGCommentNavigationPerfComponents_h */
