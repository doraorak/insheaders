...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGVideoCallJoinIntentTarget_h
#define IGVideoCallJoinIntentTarget_h
@import Foundation;
...
/* instance methods */
- (id)initWithTrigger:(long long)trigger key:(id)key type:(long long)type threadId:(id)id threadDisplayName:(id)name threadUsers:(id)users openThreadId:(id)id armadilloThreadId:(id)id occamadilloThreadId:(id)id isE2eeMandated:(BOOL)mandated isCutoverThread:(BOOL)thread productParams:(id)params callFunnelClient:(id)client;
@end

#endif /* IGVideoCallJoinIntentTarget_h */
