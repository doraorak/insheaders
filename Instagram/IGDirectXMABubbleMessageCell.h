...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGDirectXMABubbleMessageCell_h
#define IGDirectXMABubbleMessageCell_h
@import Foundation;
...
@class IGFixedFrameLayout, IGImageView, IGStackLayout, NSString, UILabel;
...
#endif /* IGDirectXMABubbleMessageCell_h */
