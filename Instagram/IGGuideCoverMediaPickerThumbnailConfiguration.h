...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGGuideCoverMediaPickerThumbnailConfiguration_h
#define IGGuideCoverMediaPickerThumbnailConfiguration_h
@import Foundation;
...
#endif /* IGGuideCoverMediaPickerThumbnailConfiguration_h */
