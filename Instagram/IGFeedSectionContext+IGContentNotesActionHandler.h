...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGFeedSectionContext_IGContentNotesActionHandler_h
#define IGFeedSectionContext_IGContentNotesActionHandler_h
@import Foundation;
...
@interface IGFeedSectionContext (IGContentNotesActionHandler)
/* instance methods */
- (id)contentNotesActionHandler;
@end

#endif /* IGFeedSectionContext_IGContentNotesActionHandler_h */
