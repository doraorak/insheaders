...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGGalleryDownwardFrameSetter_h
#define IGGalleryDownwardFrameSetter_h
@import Foundation;
...
@interface IGGalleryDownwardFrameSetter : NSObject<NSObject> {
  /* instance variables */
...
#endif /* IGGalleryDownwardFrameSetter_h */
