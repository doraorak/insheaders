...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGDiscoveryGridAdCTABanner_h
#define IGDiscoveryGridAdCTABanner_h
@import Foundation;
...
@class IGGradientView, IGMedia, NSNumber, NSString, UIColor, UIImageView, UILabel, UIView;
@protocol IGDiscoveryGridAdOverlayViewDelegate;

@interface IGDiscoveryGridAdCTABanner : IGALButton<IGFeedItemCTAButtonCellConfigurable> {
  /* instance variables */
  unsigned long long _ctaBannerState;
  UILabel *_ctaActionLabel;
  UIImageView *_rightAccessoryImageView;
  IGGradientView *_ctaGradientView;
  UIView *_ctaBackgroundView;
  NSObject<IGDiscoveryGridAdOverlayViewDelegate> *_overlayViewDelegate;
...
#endif /* IGDiscoveryGridAdCTABanner_h */
