...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGLocationHeaderInfoSectionController_h
#define IGLocationHeaderInfoSectionController_h
@import Foundation;
...
@interface IGLocationHeaderInfoSectionController : IGListGenericSectionController<IGTransitionZoomFromCapable, IGInteractiveDismissTransitionControllerDelegate, IGCreationViewControllerNavigationDelegate> {
  /* instance variables */
...
/* instance methods */
- (id)initWithUserSession:(id)session mapSessionID:(id)id analyticsModule:(id)module;
...
#endif /* IGLocationHeaderInfoSectionController_h */
