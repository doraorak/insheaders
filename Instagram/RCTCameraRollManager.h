...
#include "NativeCameraRollManagerSpec-Protocol.h"
#include "RCTBridge.h"
...
+ (id)moduleName;
+ (void)load;
+ (const struct RCTMethodInfo *)__rct_export__1610;
+ (const struct RCTMethodInfo *)__rct_export__2611;

/* instance methods */
- (void)saveToCameraRoll:(id)roll type:(id)type resolve:(id /* block */)resolve reject:(id /* block */)reject;
- (void)getPhotos:(struct GetPhotosParams *)photos resolve:(id /* block */)resolve reject:(id /* block */)reject;
