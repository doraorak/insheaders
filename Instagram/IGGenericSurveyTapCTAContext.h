...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGGenericSurveyTapCTAContext_h
#define IGGenericSurveyTapCTAContext_h
@import Foundation;
...
@interface IGGenericSurveyTapCTAContext : NSObject<IGFeedSectionControllerActionDelegate> {
  /* instance variables */
  NSObject<IGGenericSurveyTapCTAContextDelegate> *_receiver;
  BOOL _hasCTATapped;
}
...
#endif /* IGGenericSurveyTapCTAContext_h */
