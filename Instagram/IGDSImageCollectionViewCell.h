...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGDSImageCollectionViewCell_h
#define IGDSImageCollectionViewCell_h
@import Foundation;

#include "UICollectionViewCell.h"
#include "IGDSImageCellView.h"
#include "IGDSImageCellViewModel.h"
#include "IGImageViewDelegate-Protocol.h"
#include "IGListBindable-Protocol.h"

@class NSString;

@interface IGDSImageCollectionViewCell : UICollectionViewCell<IGListBindable, IGImageViewDelegate>

@property (readonly, nonatomic) IGDSImageCellView *view;
@property (readonly, nonatomic) IGDSImageCellViewModel *viewModel;
...
#endif /* IGDSImageCollectionViewCell_h */
