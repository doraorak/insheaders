...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGStoryViewerBarcelonaReshareAttributionController_h
#define IGStoryViewerBarcelonaReshareAttributionController_h
@import Foundation;
...
@interface IGStoryViewerBarcelonaReshareAttributionController : NSObject<IGStoryViewerHeaderAttributionType> {
  /* instance variables */
  IGMedia *_media;
...
/* instance methods */
- (id)initWithMedia:(id)media analyticsModule:(id)module userSession:(id)session;
...
#endif /* IGStoryViewerBarcelonaReshareAttributionController_h */
