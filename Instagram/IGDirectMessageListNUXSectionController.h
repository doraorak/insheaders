...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGDirectMessageListNUXSectionController_h
#define IGDirectMessageListNUXSectionController_h
@import Foundation;

#include "IGListBindingSingleSectionController.h"
#include "IGDirectMessageListNUXViewModel.h"
#include "IGListDisplayDelegate-Protocol.h"

@class IGDirectThreadScopedNUXProvider, NSString;
...
/* instance methods */
- (id)initWithThreadScopedNUXProvider:(id)nuxprovider;
- (Class)cellClass;
...
#endif /* IGDirectMessageListNUXSectionController_h */
