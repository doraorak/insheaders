...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGHScrollAYMFCellSectionControllerDelegate_Protocol_h
#define IGHScrollAYMFCellSectionControllerDelegate_Protocol_h
@import Foundation;
...
#endif /* IGHScrollAYMFCellSectionControllerDelegate_Protocol_h */
