...
//    - LC_SOURCE_VERSION: 
//
#ifndef _TtC6IGOpal23IGOpalNuxViewController_h
#define _TtC6IGOpal23IGOpalNuxViewController_h
@import Foundation;

#include "IGViewController.h"

@interface _TtC6IGOpal23IGOpalNuxViewController : IGViewController { // (Swift)
  /* instance variables */
   userSession;
   viewModels;
   delegate;
...
#endif /* _TtC6IGOpal23IGOpalNuxViewController_h */
