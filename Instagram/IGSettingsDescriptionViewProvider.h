...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGSettingsDescriptionViewProvider_h
#define IGSettingsDescriptionViewProvider_h
@import Foundation;
...
@interface IGSettingsDescriptionViewProvider : NSObject<NSObject> {
  /* instance variables */
...
#endif /* IGSettingsDescriptionViewProvider_h */
