...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGHighlightsFeedPostSelectionDelegate_h
#define IGHighlightsFeedPostSelectionDelegate_h
@import Foundation;
...
@interface IGHighlightsFeedPostSelectionDelegate : NSObject<IGFeedCreationFlowDelegate, IGSundialPostCaptureEditingViewControllerDelegate> {
  /* instance variables */
  UIViewController *_viewController;
  UINavigationController *_feedPostSelectionNavigationController;
...
- (void)feedPostSelectionViewControllerDidTapCancel:(id)cancel;
- (void)feedPostSelectionViewController:(id)controller didSelectNextWithMediaItems:(id)items fromHighlightPk:(id)pk highlightTitle:(id)title;
- (void)feedPostSelectionViewController:(id)controller didSelectNextWithVideoMediaMetadata:(id)metadata;
...
#endif /* IGHighlightsFeedPostSelectionDelegate_h */
