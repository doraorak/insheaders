...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGAutocompleteControllerTextInput_Protocol_h
#define IGAutocompleteControllerTextInput_Protocol_h
@import Foundation;
...
#endif /* IGAutocompleteControllerTextInput_Protocol_h */
