...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGSundialCreationPreviewAudioAsset_h
#define IGSundialCreationPreviewAudioAsset_h
@import Foundation;
...
/* instance methods */
- (id)initWithCreationUser:(id)user audioTrack:(id)track;
- (id)initWithCoder:(id)coder;
- (void)encodeWithCoder:(id)coder;
@end

#endif /* IGSundialCreationPreviewAudioAsset_h */
