...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGDirectFeedItemConfiguration_h
#define IGDirectFeedItemConfiguration_h
@import Foundation;

#include "IGFeedItemConfigurationType-Protocol.h"
#include "IGSingleFeedItemConfiguration.h"
...
- (id)initWithUserSession:(id)session overridenCarouselPostItemPk:(id)pk collabInviteResponse:(id)response shouldShowCallButtons:(BOOL)buttons;
- (id)theme;
- (id)headerTheme;
...
#endif /* IGDirectFeedItemConfiguration_h */
