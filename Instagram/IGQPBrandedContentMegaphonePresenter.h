...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGQPBrandedContentMegaphonePresenter_h
#define IGQPBrandedContentMegaphonePresenter_h
@import Foundation;
...
@interface IGQPBrandedContentMegaphonePresenter : NSObject<IGQPMegaphoneViewDelegate> {
  /* instance variables */
...
#endif /* IGQPBrandedContentMegaphonePresenter_h */
