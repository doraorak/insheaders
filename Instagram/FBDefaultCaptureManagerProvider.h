...
//    - LC_SOURCE_VERSION: 
//
#ifndef FBDefaultCaptureManagerProvider_h
#define FBDefaultCaptureManagerProvider_h
@import Foundation;
...
@interface FBDefaultCaptureManagerProvider : NSObject<NSObject>
...
#endif /* FBDefaultCaptureManagerProvider_h */
