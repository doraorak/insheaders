...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGDirectSmartSuggestionsSubscriptionPublisher_h
#define IGDirectSmartSuggestionsSubscriptionPublisher_h
@import Foundation;
...
@interface IGDirectSmartSuggestionsSubscriptionPublisher : NSObject<MDCDataSubscriptionPublishing> {
  /* instance variables */
...
#endif /* IGDirectSmartSuggestionsSubscriptionPublisher_h */
