...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGNetegoSurveyLearnMoreMessageCell_h
#define IGNetegoSurveyLearnMoreMessageCell_h
@import Foundation;
...
@interface IGNetegoSurveyLearnMoreMessageCell : UICollectionViewCell<IGCoreTextLinkHandler> {
  ...
  NSObject<IGNetegoSurveyLearnMoreMessageCellDelegate> *_delegate;
}
...
#endif /* IGNetegoSurveyLearnMoreMessageCell_h */
