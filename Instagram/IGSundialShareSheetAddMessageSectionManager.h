...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGSundialShareSheetAddMessageSectionManager_h
#define IGSundialShareSheetAddMessageSectionManager_h
@import Foundation;

#include "_TtP26IGSundialShareSheetContext34IGSundialShareSheetSectionManaging_-Protocol.h"

@interface IGSundialShareSheetAddMessageSectionManager : NSObject<_TtP26IGSundialShareSheetContext34IGSundialShareSheetSectionManaging_> { // (Swift)
  /* instance variables */
   context;
   buttonManager;
}
...
#endif /* IGSundialShareSheetAddMessageSectionManager_h */
