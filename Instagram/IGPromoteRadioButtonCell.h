...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGPromoteRadioButtonCell_h
#define IGPromoteRadioButtonCell_h
@import Foundation;
...
@interface IGPromoteRadioButtonCell : UICollectionViewCell<IGCoreTextNonLinkHandler, IGCoreTextLinkHandler, UIGestureRecognizerDelegate> {
  /* instance variables */
  IGCoreTextView *_titleView;
  IGCoreTextView *_titleAppendedView;
...
@property (copy, nonatomic) IGPromoteRadioButtonViewModel *viewModel;
@property (weak, nonatomic) NSObject<IGPromoteRadioButtonCellDelegate> *delegate;
...
- (void)dealloc;
- (void)layoutSubviews;
- (struct CGPoint { double x0; double x1; })titleAppendedStringTooltipPoint;
...
#endif /* IGPromoteRadioButtonCell_h */
