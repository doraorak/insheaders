...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGShoppingMediaThumbnailConfiguration_h
#define IGShoppingMediaThumbnailConfiguration_h
@import Foundation;
...
@interface IGShoppingMediaThumbnailConfiguration : NSObject<IGMediaThumbnailConfigurationType> {
  /* instance variables */
  NSString *_productId;
  BOOL _showFeaturedProductPendingOverlay;
}
...
/* instance methods */
- (id)initWithProductId:(id)id showFeaturedProductPendingOverlay:(BOOL)overlay;
- (BOOL)allowSelection;
- (BOOL)showHighlight;
...
#endif /* IGShoppingMediaThumbnailConfiguration_h */
