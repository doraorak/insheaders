...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGFeedItemChannelCTAButtonCell_h
#define IGFeedItemChannelCTAButtonCell_h
@import Foundation;
...
@class IGMedia, NSNumber, NSString, UIColor, UIView;

@interface IGFeedItemChannelCTAButtonCell : UICollectionViewCell<IGFeedItemCTAButtonCellConfigurable, IGRenderingLoggingProviding, IGPCMEventAttributionConforming> {
  /* instance variables */
  UIView *_eventAttributionViewOverlay;
  IGFeedChannelTagView *_channelTagView;
}
...
#endif /* IGFeedItemChannelCTAButtonCell_h */
