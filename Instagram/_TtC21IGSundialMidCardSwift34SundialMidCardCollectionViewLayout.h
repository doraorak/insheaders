...
//    - LC_SOURCE_VERSION: 
//
#ifndef _TtC21IGSundialMidCardSwift34SundialMidCardCollectionViewLayout_h
#define _TtC21IGSundialMidCardSwift34SundialMidCardCollectionViewLayout_h
@import Foundation;

#include "UICollectionViewFlowLayout.h"

@interface _TtC21IGSundialMidCardSwift34SundialMidCardCollectionViewLayout : UICollectionViewFlowLayout { // (Swift)
  /* instance variables */
   interItemSpacing;
   shrinkFactor;
}
...
#endif /* _TtC21IGSundialMidCardSwift34SundialMidCardCollectionViewLayout_h */
