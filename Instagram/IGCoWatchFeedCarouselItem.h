...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGCoWatchFeedCarouselItem_h
#define IGCoWatchFeedCarouselItem_h
@import Foundation;
...
@interface IGCoWatchFeedCarouselItem : NSObject<NSObject> {
  /* instance variables */
...
/* instance methods */
- (id)initWithMedia:(id)media currentItemIndex:(long long)index;
@end

#endif /* IGCoWatchFeedCarouselItem_h */
