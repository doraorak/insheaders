...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGDirectTranslationsThreadMegaphoneActionHandler_h
#define IGDirectTranslationsThreadMegaphoneActionHandler_h
@import Foundation;
...
/* instance methods */
- (id)initWithTranslationsService:(id)service;
...
#endif /* IGDirectTranslationsThreadMegaphoneActionHandler_h */
