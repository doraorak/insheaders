...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGBloksIFYDirectShareSheetControllerDelegate_h
#define IGBloksIFYDirectShareSheetControllerDelegate_h
@import Foundation;
...
@interface IGBloksIFYDirectShareSheetControllerDelegate : NSObject<IGDirectShareSheetControllerDelegate> {
  /* instance variables */
...
#endif /* IGBloksIFYDirectShareSheetControllerDelegate_h */
