...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGShoppingPDPLightboxReelSectionController_h
#define IGShoppingPDPLightboxReelSectionController_h
@import Foundation;
...
#include "IGShoppingPDPLightboxReelViewModel.h"
...
@protocol IGShoppingPDPLightboxReelSectionControllerDelegate;

@interface IGShoppingPDPLightboxReelSectionController : IGListSectionController<IGFNFVideoPlayerDelegate, IGListDisplayDelegate> {
  /* instance variables */
...
@property (weak, nonatomic) NSObject<IGShoppingPDPLightboxReelSectionControllerDelegate> *delegate;
...
#endif /* IGShoppingPDPLightboxReelSectionController_h */
