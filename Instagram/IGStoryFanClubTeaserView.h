...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGStoryFanClubTeaserView_h
#define IGStoryFanClubTeaserView_h
@import Foundation;
...
#include "_TtC22IGFanClubUISharedSwift28IGFanClubCrownHeaderIconView.h"

@class IGImageView, IGProfilePictureImageView, NSString, UILabel;
@protocol IGStoryItemType><IGUnitItemInformationProviding;

@interface IGStoryFanClubTeaserView : UIView<IGStoryStaticMediaProgressManagerDelegate, IGStoryPlayerMediaViewType> {
  /* instance variables */
  NSObject<IGStoryItemType><IGUnitItemInformationProviding> *_item;
  IGImageView *_backgroundView;
  _TtC22IGFanClubUISharedSwift28IGFanClubCrownHeaderIconView *_iconView;
...
@property (retain, nonatomic) NSObject<IGStoryPlayerMediaViewDelegate> *delegate;
...
#endif /* IGStoryFanClubTeaserView_h */
