...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGStoryViewerArchiveAttributionController_h
#define IGStoryViewerArchiveAttributionController_h
@import Foundation;
...
@interface IGStoryViewerArchiveAttributionController : NSObject<IGStoryViewerHeaderAttributionType> {
  /* instance variables */
  NSDate *_archivedMediaTimestamp;
...
/* instance methods */
- (id)initWithArchivedMediaTimestamp:(id)timestamp isDisabledAttributionType:(BOOL)type userSession:(id)session;
...
#endif /* IGStoryViewerArchiveAttributionController_h */
