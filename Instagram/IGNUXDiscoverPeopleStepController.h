...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGNUXDiscoverPeopleStepController_h
#define IGNUXDiscoverPeopleStepController_h
@import Foundation;
...
@interface IGNUXDiscoverPeopleStepController : NSObject<NSObject> {
  /* instance variables */
...
#endif /* IGNUXDiscoverPeopleStepController_h */
