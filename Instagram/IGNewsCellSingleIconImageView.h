...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGNewsCellSingleIconImageView_h
#define IGNewsCellSingleIconImageView_h
@import Foundation;

#include "UIView.h"
#include "IGImageViewDelegate-Protocol.h"

@class CAShapeLayer, IGImageView, NSString, UIColor;

@interface IGNewsCellSingleIconImageView : UIView<IGImageViewDelegate> {
  /* instance variables */
  IGImageView *_iconImageView;
  CAShapeLayer *_imageRing;
  UIColor *_imageTint;
  BOOL _roundFrontIcon;
  BOOL _tintFrontIcon;
  BOOL _isUsingIconImage;
  double _imageSize;
}
...
#endif /* IGNewsCellSingleIconImageView_h */
