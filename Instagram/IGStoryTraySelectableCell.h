...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGStoryTraySelectableCell_h
#define IGStoryTraySelectableCell_h
@import Foundation;

#include "IGStoryTrayCell.h"
...
@interface IGStoryTraySelectableCell : IGStoryTrayCell<IGStoryTraySelectableCellProtocol> {
  /* instance variables */
...
#endif /* IGStoryTraySelectableCell_h */
