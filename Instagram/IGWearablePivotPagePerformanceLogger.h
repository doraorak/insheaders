...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGWearablePivotPagePerformanceLogger_h
#define IGWearablePivotPagePerformanceLogger_h
@import Foundation;
...
@interface IGWearablePivotPagePerformanceLogger : NSObject<IGSundialGridPerformanceLogger> {
  /* instance variables */
  NSString *_mediaId;
  int _instanceKey;
}
...
#endif /* IGWearablePivotPagePerformanceLogger_h */
