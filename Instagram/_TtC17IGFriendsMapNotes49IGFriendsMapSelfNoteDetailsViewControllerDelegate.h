...
//    - LC_SOURCE_VERSION: 
//
#ifndef _TtC17IGFriendsMapNotes49IGFriendsMapSelfNoteDetailsViewControllerDelegate_h
#define _TtC17IGFriendsMapNotes49IGFriendsMapSelfNoteDetailsViewControllerDelegate_h
@import Foundation;

#include "IGDirectNoteDetailsViewControllerDelegate-Protocol.h"

@interface _TtC17IGFriendsMapNotes49IGFriendsMapSelfNoteDetailsViewControllerDelegate : NSObject<IGDirectNoteDetailsViewControllerDelegate> { // (Swift)
  /* instance variables */
   userSession;
   didTapNewNoteBlock;
   optimisticNoteDeletionBlock;
}
...
#endif /* _TtC17IGFriendsMapNotes49IGFriendsMapSelfNoteDetailsViewControllerDelegate_h */
