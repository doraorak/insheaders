...
//    - LC_SOURCE_VERSION: 
//
#ifndef SNAdMetadata_h
#define SNAdMetadata_h
@import Foundation;
...
/* instance methods */
- (id)initWithAdId:(id)id templateName:(id)name trackingId:(id)id clientName:(id)name extensions:(id)extensions;
@end

#endif /* SNAdMetadata_h */
