...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGDirectBottomSheetThreadCreatorInboxFilterTypeViewController_h
#define IGDirectBottomSheetThreadCreatorInboxFilterTypeViewController_h
@import Foundation;
...
@interface IGDirectBottomSheetThreadCreatorInboxFilterTypeViewController : IGViewController<IGListAdapterDataSource, IGDSListSectionControllerDataSource, IGDSListSectionControllerDelegate, IGGestureHandler> {
  /* instance variables */
...
#endif /* IGDirectBottomSheetThreadCreatorInboxFilterTypeViewController_h */
