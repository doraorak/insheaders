...
//    - LC_SOURCE_VERSION: 
//
#ifndef MpOperationalActivityLogSink_h
#define MpOperationalActivityLogSink_h
@import Foundation;
...
@interface MpOperationalActivityLogSink : NSObject<NSObject> {
  /* instance variables */
...
#endif /* MpOperationalActivityLogSink_h */
