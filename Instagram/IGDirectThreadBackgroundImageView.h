...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGDirectThreadBackgroundImageView_h
#define IGDirectThreadBackgroundImageView_h
@import Foundation;
...
@interface IGDirectThreadBackgroundImageView : UIView<IGImageViewDelegate> {
  /* instance variables */
...
#endif /* IGDirectThreadBackgroundImageView_h */
