...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGCTMessagingAdsStoryFooterView_h
#define IGCTMessagingAdsStoryFooterView_h
@import Foundation;
...
@class IGDirectComposer, IGTapButton, NSString;
@protocol IGCTMessagingAdsStoryFooterViewDelegate;

@interface IGCTMessagingAdsStoryFooterView : UIView<IGDirectComposerButtonDelegate, IGDirectComposerTextListener, IGDirectComposerSizingDelegate> {
  /* instance variables */
  IGDirectComposer *_composer;
  IGTapButton *_reshareButton;
}

@property (weak, nonatomic) NSObject<IGCTMessagingAdsStoryFooterViewDelegate> *delegate;
...
/* instance methods */
- (id)initWithAutocapitalizationType:(long long)type;
...
#endif /* IGCTMessagingAdsStoryFooterView_h */
