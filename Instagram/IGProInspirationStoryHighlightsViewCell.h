...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGProInspirationStoryHighlightsViewCell_h
#define IGProInspirationStoryHighlightsViewCell_h
@import Foundation;
...
@interface IGProInspirationStoryHighlightsViewCell : IGBouncyCollectionViewCell<IGImageViewDelegate> {
  /* instance variables */
...
#endif /* IGProInspirationStoryHighlightsViewCell_h */
