...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGSundialShareSheetMetaVerifiedLinkSectionManager_h
#define IGSundialShareSheetMetaVerifiedLinkSectionManager_h
@import Foundation;

#include "_TtP26IGSundialShareSheetContext34IGSundialShareSheetSectionManaging_-Protocol.h"

@interface IGSundialShareSheetMetaVerifiedLinkSectionManager : NSObject<_TtP26IGSundialShareSheetContext34IGSundialShareSheetSectionManaging_> { // (Swift)
  /* instance variables */
   context;
   kImpressionLimit;
}
...
#endif /* IGSundialShareSheetMetaVerifiedLinkSectionManager_h */
