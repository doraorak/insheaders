...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGDirectThreadLoadingViewModelInstructionsGenerator_h
#define IGDirectThreadLoadingViewModelInstructionsGenerator_h
@import Foundation;
...
@interface IGDirectThreadLoadingViewModelInstructionsGenerator : NSObject<NSObject> {
  /* instance variables */
...
/* instance methods */
- (id)initWithThemeProvider:(id)provider contentStringStylesProvider:(id)provider featureSetProvider:(id)provider;
- (id)generateInstructionsForMessages:(id)messages generationInput:(id)input previousGenerationOutput:(id)output;
@end

#endif /* IGDirectThreadLoadingViewModelInstructionsGenerator_h */
