...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGSundialAdsPhotoCell_h
#define IGSundialAdsPhotoCell_h
@import Foundation;
...
@protocol IGSundialAdsPhotoCellDelegate;

@interface IGSundialAdsPhotoCell : UICollectionViewCell<IGHeartAnimatable, IGSundialViewerInteractionCellType, IGSundialControlsOverlaySupporting> {
  /* instance variables */
  IGAdItem *_adItem;
...
@property (weak, nonatomic) NSObject<IGSundialAdsPhotoCellDelegate> *delegate;
