...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGBrandedContentRequestAdAccessTapHandler_h
#define IGBrandedContentRequestAdAccessTapHandler_h
@import Foundation;
...
/* instance methods */
- (id)initWithUserSession:(id)session analyticsModule:(id)module priorModule:(id)module;
...
#endif /* IGBrandedContentRequestAdAccessTapHandler_h */
