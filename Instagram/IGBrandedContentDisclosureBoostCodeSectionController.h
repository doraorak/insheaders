...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGBrandedContentDisclosureBoostCodeSectionController_h
#define IGBrandedContentDisclosureBoostCodeSectionController_h
@import Foundation;
...
@class IGBrandedContentAdBoostPostToken, NSString;
@protocol IGBrandedContentDisclosureBoostCodeSectionControllerDelegate;

@interface IGBrandedContentDisclosureBoostCodeSectionController : IGListBindingSectionController<IGListSupplementaryViewSource, IGDSSectionFooterViewDelegate, IGListBindingSectionControllerDataSource, IGListBindingSectionControllerSelectionDelegate> {
  /* instance variables */
  NSObject<IGBrandedContentDisclosureBoostCodeSectionControllerDelegate> *_delegate;
...
- (void)copyBrandedContentAdCode:(id)code;
- (void)showBrandedContentAdCodeMoreActionSheet:(id)sheet;
@end

#endif /* IGBrandedContentDisclosureBoostCodeSectionController_h */
