...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGStoryViewerCreateModeAttributionController_h
#define IGStoryViewerCreateModeAttributionController_h
@import Foundation;
...
/* instance methods */
- (id)initWithCreateModeAttributionModel:(id)model isDisabledAttributionType:(BOOL)type;
...
#endif /* IGStoryViewerCreateModeAttributionController_h */
