...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGGenericSurveyAnswerListCollectionViewFlowLayout_h
#define IGGenericSurveyAnswerListCollectionViewFlowLayout_h
@import Foundation;
...
#endif /* IGGenericSurveyAnswerListCollectionViewFlowLayout_h */
