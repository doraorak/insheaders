...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGCanvasProductListSectionController_h
#define IGCanvasProductListSectionController_h
@import Foundation;

#include "IGListSectionController.h"
#include "IGCanvasActionHelper.h"
#include "IGCanvasLoggingContext.h"
#include "IGCanvasProductListViewModel.h"
#include "IGListDisplayDelegate-Protocol.h"

@class NSMutableDictionary, NSString, UIColor;

@interface IGCanvasProductListSectionController : IGListSectionController<IGListDisplayDelegate> {
  /* instance variables */
...
/* instance methods */
- (id)initWithActionHelper:(id)helper loggingContext:(id)context;
