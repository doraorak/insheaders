...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGSundialStaticFeedNetworkSource_h
#define IGSundialStaticFeedNetworkSource_h
@import Foundation;
...
@interface IGSundialStaticFeedNetworkSource : IGFeedNetworkSource<IGSundialFeedSource> {
  /* instance variables */
...
/* instance methods */
- (id)initWithPosts:(id)posts sundialConsumptionAPISessionDeps:(id)deps;
...
#endif /* IGSundialStaticFeedNetworkSource_h */
