...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGSundialGridProfileGraphQLFetcher_h
#define IGSundialGridProfileGraphQLFetcher_h
@import Foundation;
...
@interface IGSundialGridProfileGraphQLFetcher : NSObject<NSObject> {
  /* instance variables */
...
#endif /* IGSundialGridProfileGraphQLFetcher_h */
