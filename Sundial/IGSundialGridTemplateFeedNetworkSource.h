...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGSundialGridTemplateFeedNetworkSource_h
#define IGSundialGridTemplateFeedNetworkSource_h
@import Foundation;
...
#include "IGSundialGridTemplatePageMetadata.h"
#include "IGSundialMusicAsset.h"
#include "IGSundialOriginalAudioAsset.h"
#include "IGSundialTemplateFeedSource-Protocol.h"

@class NSArray, NSDictionary, NSString;
@protocol IGFeedNetworkSourceDelegateAnnouncer, IGSundialFeedNetworkSourceDelegate;

@interface IGSundialGridTemplateFeedNetworkSource : IGSundialFeedNetworkSource<IGSundialTemplateFeedSource>

@property (retain, nonatomic) NSString *templateId;
@property (readonly, nonatomic) IGSundialGridTemplatePageMetadata *templatePageMetadata;
...
#endif /* IGSundialGridTemplateFeedNetworkSource_h */
