...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGSundialShareSheetRenameAudioSectionManager_h
#define IGSundialShareSheetRenameAudioSectionManager_h
@import Foundation;

#include "_TtP26IGSundialShareSheetContext34IGSundialShareSheetSectionManaging_-Protocol.h"

@interface IGSundialShareSheetRenameAudioSectionManager : NSObject<_TtP26IGSundialShareSheetContext34IGSundialShareSheetSectionManaging_> { // (Swift)
  /* instance variables */
   context;
}
...
#endif /* IGSundialShareSheetRenameAudioSectionManager_h */
