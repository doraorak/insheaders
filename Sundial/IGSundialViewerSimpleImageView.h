...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGSundialViewerSimpleImageView_h
#define IGSundialViewerSimpleImageView_h
@import Foundation;
...
@protocol IGSundialViewerSimpleImageViewDelegate;

@interface IGSundialViewerSimpleImageView : UIView<IGImageViewDelegate, _TtP17IGZoomInteraction25IGZoomInteractionDelegate_, IGSundialViewerControlsOverlayLayoutDelegate> {
  /* instance variables */
...
@property (weak, nonatomic) NSObject<IGSundialViewerSimpleImageViewDelegate> *delegate;
...
#endif /* IGSundialViewerSimpleImageView_h */
