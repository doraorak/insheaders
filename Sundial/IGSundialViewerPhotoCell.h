...
//    - LC_SOURCE_VERSION: 
//
#ifndef IGSundialViewerPhotoCell_h
#define IGSundialViewerPhotoCell_h
@import Foundation;
...
@class IGImmersiveFeedConfiguration, IGMedia, IGMediaOverlayView, NSString, UIView;
@protocol IGSundialViewerPhotoCellDelegate;

@interface IGSundialViewerPhotoCell : UICollectionViewCell<IGMediaOverlayDelegate, IGFeedAudioPlayable, IGHeartAnimatable, IGMediaViewProvider, IGSundialAudioToggleable, IGSundialPlaybackIsPlaying, IGSundialPlaybackToggleHosting, IGSundialControlsOverlaySupporting, IGSundialViewerInteractionCellType, IGSundialLinkedHighlightCompatible> {
  /* instance variables */
  IGMedia *_media;
...
@property (weak, nonatomic) NSObject<IGSundialViewerPhotoCellDelegate> *delegate;
...
#endif /* IGSundialViewerPhotoCell_h */
